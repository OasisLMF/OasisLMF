...
import os
import pytest
from oasislmf.pytools.indexconvert import change_footprint_apid_multi_peril, change_footprint_apid
...
def test_indexconvert():
    ...
    correct_file = os.path.join(test_dir, "indexconvert_test_correct1peril.csv")
...
def test_indexconvert_multiperil():
    ...
    input_file = os.path.join(test_dir, "indexconvert_test_data.csv")
    temp_file = os.path.join(test_dir, "indexconvert_test_temp.csv")
    correct_file = os.path.join(test_dir, "indexconvert_test_correct3peril.csv")
