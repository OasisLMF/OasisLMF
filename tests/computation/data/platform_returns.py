...
PORT_TABLE = """+------+---------------------------+-----------------+-----------------+-------------------------+--------------------------+---------------------+-------------------+
|   id | name                      | location_file   | accounts_file   | reinsurance_info_file   | reinsurance_scope_file   | validation_status   | exposure_status   |
|------+---------------------------+-----------------+-----------------+-------------------------+--------------------------+---------------------+-------------------|
|    1 | Portfolio_31052023-145540 | Yes             | Yes             | Yes                     | Yes                      | RUN_COMPLETED       | NONE              |
|    2 | Portfolio_31052023-150223 | Yes             | Yes             | -                       | -                        | NONE                | NONE              |
+------+---------------------------+-----------------+-----------------+-------------------------+--------------------------+---------------------+-------------------+"""
