...
( eve 1 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P1  ) &  pid41=$!
( eve 2 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P2  ) &  pid42=$!
( eve 3 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P3  ) &  pid43=$!
( eve 4 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P4  ) &  pid44=$!
( eve 5 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P5  ) &  pid45=$!
( eve 6 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P6  ) &  pid46=$!
( eve 7 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P7  ) &  pid47=$!
( eve 8 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P8  ) &  pid48=$!
( eve 9 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P9  ) &  pid49=$!
( eve 10 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P10  ) &  pid50=$!
( eve 11 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P11  ) &  pid51=$!
( eve 12 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P12  ) &  pid52=$!
( eve 13 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P13  ) &  pid53=$!
( eve 14 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P14  ) &  pid54=$!
( eve 15 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P15  ) &  pid55=$!
( eve 16 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P16  ) &  pid56=$!
( eve 17 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P17  ) &  pid57=$!
( eve 18 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P18  ) &  pid58=$!
( eve 19 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P19  ) &  pid59=$!
( eve 20 20 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P20  ) &  pid60=$!
