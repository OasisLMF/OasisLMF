...
( eve 1 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P1  ) &  pid101=$!
( eve 2 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P2  ) &  pid102=$!
( eve 3 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P3  ) &  pid103=$!
( eve 4 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P4  ) &  pid104=$!
( eve 5 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P5  ) &  pid105=$!
( eve 6 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P6  ) &  pid106=$!
( eve 7 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P7  ) &  pid107=$!
( eve 8 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P8  ) &  pid108=$!
( eve 9 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P9  ) &  pid109=$!
( eve 10 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P10  ) &  pid110=$!
