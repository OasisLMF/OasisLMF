...
( evepy 1 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P1  ) &  pid41=$!
( evepy 2 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P2  ) &  pid42=$!
( evepy 3 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P3  ) &  pid43=$!
( evepy 4 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P4  ) &  pid44=$!
( evepy 5 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P5  ) &  pid45=$!
( evepy 6 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P6  ) &  pid46=$!
( evepy 7 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P7  ) &  pid47=$!
( evepy 8 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P8  ) &  pid48=$!
( evepy 9 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P9  ) &  pid49=$!
( evepy 10 10 | getmodel | gulcalc -S0 -L0 -r -c - > fifo/gul_P10  ) &  pid50=$!
