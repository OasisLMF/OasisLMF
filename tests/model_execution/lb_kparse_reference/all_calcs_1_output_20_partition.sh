...
( evepy 1 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P1 > fifo/gul_lb_P1  ) & 
( evepy 2 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P2 > fifo/gul_lb_P2  ) & 
( evepy 3 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P3 > fifo/gul_lb_P3  ) & 
( evepy 4 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P4 > fifo/gul_lb_P4  ) & 
( evepy 5 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P5 > fifo/gul_lb_P5  ) & 
( evepy 6 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P6 > fifo/gul_lb_P6  ) & 
( evepy 7 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P7 > fifo/gul_lb_P7  ) & 
( evepy 8 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P8 > fifo/gul_lb_P8  ) & 
( evepy 9 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P9 > fifo/gul_lb_P9  ) & 
( evepy 10 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P10 > fifo/gul_lb_P10  ) & 
...
( fmpy -a2 < fifo/lb_il_P1 > fifo/il_P1 ) & pid101=$!
( fmpy -a2 < fifo/lb_il_P2 > fifo/il_P2 ) & pid102=$!
( fmpy -a2 < fifo/lb_il_P3 > fifo/il_P3 ) & pid103=$!
( fmpy -a2 < fifo/lb_il_P4 > fifo/il_P4 ) & pid104=$!
( fmpy -a2 < fifo/lb_il_P5 > fifo/il_P5 ) & pid105=$!
( fmpy -a2 < fifo/lb_il_P6 > fifo/il_P6 ) & pid106=$!
( fmpy -a2 < fifo/lb_il_P7 > fifo/il_P7 ) & pid107=$!
( fmpy -a2 < fifo/lb_il_P8 > fifo/il_P8 ) & pid108=$!
( fmpy -a2 < fifo/lb_il_P9 > fifo/il_P9 ) & pid109=$!
( fmpy -a2 < fifo/lb_il_P10 > fifo/il_P10 ) & pid110=$!
