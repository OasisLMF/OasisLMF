...
( evepy 1 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P1  ) &  pid101=$!
( evepy 2 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P2  ) &  pid102=$!
( evepy 3 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P3  ) &  pid103=$!
( evepy 4 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P4  ) &  pid104=$!
( evepy 5 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P5  ) &  pid105=$!
( evepy 6 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P6  ) &  pid106=$!
( evepy 7 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P7  ) &  pid107=$!
( evepy 8 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P8  ) &  pid108=$!
( evepy 9 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P9  ) &  pid109=$!
( evepy 10 10 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P10  ) &  pid110=$!
