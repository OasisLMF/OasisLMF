...
eve -R 3 20 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P3 | fmcalc -a2 > fifo/il_P3  &
...
kat -u work/kat/gul_S1_eltcalc_P3 > output/gul_S1_eltcalc.csv & kpid4=$!
kat -u work/kat/gul_S1_pltcalc_P3 > output/gul_S1_pltcalc.csv & kpid5=$!
kat -u work/kat/gul_S1_summarycalc_P3 > output/gul_S1_summarycalc.csv & kpid6=$!
