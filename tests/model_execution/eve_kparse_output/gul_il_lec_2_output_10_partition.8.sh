...
kat -u work/kat/il_S1_eltcalc_P9 > output/il_S1_eltcalc.csv & kpid1=$!
kat -u work/kat/il_S1_pltcalc_P9 > output/il_S1_pltcalc.csv & kpid2=$!
kat -u work/kat/il_S1_summarycalc_P9 > output/il_S1_summarycalc.csv & kpid3=$!
kat -u work/kat/il_S2_eltcalc_P9 > output/il_S2_eltcalc.csv & kpid4=$!
kat -u work/kat/il_S2_pltcalc_P9 > output/il_S2_pltcalc.csv & kpid5=$!
kat -u work/kat/il_S2_summarycalc_P9 > output/il_S2_summarycalc.csv & kpid6=$!

# --- Do ground up loss kats ---

kat -u work/kat/gul_S1_eltcalc_P9 > output/gul_S1_eltcalc.csv & kpid7=$!
kat -u work/kat/gul_S1_pltcalc_P9 > output/gul_S1_pltcalc.csv & kpid8=$!
kat -u work/kat/gul_S1_summarycalc_P9 > output/gul_S1_summarycalc.csv & kpid9=$!
kat -u work/kat/gul_S2_eltcalc_P9 > output/gul_S2_eltcalc.csv & kpid10=$!
kat -u work/kat/gul_S2_pltcalc_P9 > output/gul_S2_pltcalc.csv & kpid11=$!
kat -u work/kat/gul_S2_summarycalc_P9 > output/gul_S2_summarycalc.csv & kpid12=$!
