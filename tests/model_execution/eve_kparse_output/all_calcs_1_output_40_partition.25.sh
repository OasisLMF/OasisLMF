...
eve -R 26 40 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P26 | fmcalc -a2 > fifo/il_P26  &
...
kat -u work/kat/il_S1_eltcalc_P26 > output/il_S1_eltcalc.csv & kpid1=$!
kat -u work/kat/il_S1_pltcalc_P26 > output/il_S1_pltcalc.csv & kpid2=$!
kat -u work/kat/il_S1_summarycalc_P26 > output/il_S1_summarycalc.csv & kpid3=$!

# --- Do ground up loss kats ---

kat -u work/kat/gul_S1_eltcalc_P26 > output/gul_S1_eltcalc.csv & kpid4=$!
kat -u work/kat/gul_S1_pltcalc_P26 > output/gul_S1_pltcalc.csv & kpid5=$!
kat -u work/kat/gul_S1_summarycalc_P26 > output/gul_S1_summarycalc.csv & kpid6=$!
