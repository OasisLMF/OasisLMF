...
eve -R 15 40 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P15 | fmcalc -a2 > fifo/il_P15  &
...
kat -u work/kat/il_S1_eltcalc_P15 > output/il_S1_eltcalc.csv & kpid1=$!
kat -u work/kat/il_S1_pltcalc_P15 > output/il_S1_pltcalc.csv & kpid2=$!
kat -u work/kat/il_S1_summarycalc_P15 > output/il_S1_summarycalc.csv & kpid3=$!

# --- Do ground up loss kats ---

kat -u work/kat/gul_S1_eltcalc_P15 > output/gul_S1_eltcalc.csv & kpid4=$!
kat -u work/kat/gul_S1_pltcalc_P15 > output/gul_S1_pltcalc.csv & kpid5=$!
kat -u work/kat/gul_S1_summarycalc_P15 > output/gul_S1_summarycalc.csv & kpid6=$!
