...
eve -R 7 40 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P7 | fmcalc -a2 > fifo/il_P7  &
...
kat -u work/kat/gul_S1_eltcalc_P7 > output/gul_S1_eltcalc.csv & kpid4=$!
kat -u work/kat/gul_S1_pltcalc_P7 > output/gul_S1_pltcalc.csv & kpid5=$!
kat -u work/kat/gul_S1_summarycalc_P7 > output/gul_S1_summarycalc.csv & kpid6=$!
