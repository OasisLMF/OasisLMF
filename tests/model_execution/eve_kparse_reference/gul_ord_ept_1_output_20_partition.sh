...
( evepy -R 1 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P1  ) &  pid41=$!
( evepy -R 2 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P2  ) &  pid42=$!
( evepy -R 3 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P3  ) &  pid43=$!
( evepy -R 4 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P4  ) &  pid44=$!
( evepy -R 5 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P5  ) &  pid45=$!
( evepy -R 6 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P6  ) &  pid46=$!
( evepy -R 7 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P7  ) &  pid47=$!
( evepy -R 8 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P8  ) &  pid48=$!
( evepy -R 9 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P9  ) &  pid49=$!
( evepy -R 10 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P10  ) &  pid50=$!
( evepy -R 11 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P11  ) &  pid51=$!
( evepy -R 12 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P12  ) &  pid52=$!
( evepy -R 13 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P13  ) &  pid53=$!
( evepy -R 14 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P14  ) &  pid54=$!
( evepy -R 15 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P15  ) &  pid55=$!
( evepy -R 16 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P16  ) &  pid56=$!
( evepy -R 17 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P17  ) &  pid57=$!
( evepy -R 18 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P18  ) &  pid58=$!
( evepy -R 19 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P19  ) &  pid59=$!
( evepy -R 20 20 | getmodel | gulcalc -S0 -L0 -r -a0 -i - > fifo/gul_P20  ) &  pid60=$!
