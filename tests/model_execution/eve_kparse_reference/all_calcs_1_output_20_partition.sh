...
( evepy -R 1 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P1 > fifo/gul_lb_P1  ) & 
( evepy -R 2 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P2 > fifo/gul_lb_P2  ) & 
( evepy -R 3 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P3 > fifo/gul_lb_P3  ) & 
( evepy -R 4 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P4 > fifo/gul_lb_P4  ) & 
( evepy -R 5 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P5 > fifo/gul_lb_P5  ) & 
( evepy -R 6 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P6 > fifo/gul_lb_P6  ) & 
( evepy -R 7 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P7 > fifo/gul_lb_P7  ) & 
( evepy -R 8 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P8 > fifo/gul_lb_P8  ) & 
( evepy -R 9 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P9 > fifo/gul_lb_P9  ) & 
( evepy -R 10 10 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P10 > fifo/gul_lb_P10  ) & 
