...
eve -R 5 20 | getmodel | gulcalc -S100 -L100 -r -a0 -i - | tee fifo/gul_P5 | fmcalc -a2 > fifo/il_P5  &
...
kat -u work/kat/gul_S1_eltcalc_P5 > output/gul_S1_eltcalc.csv & kpid4=$!
kat -u work/kat/gul_S1_pltcalc_P5 > output/gul_S1_pltcalc.csv & kpid5=$!
kat -u work/kat/gul_S1_summarycalc_P5 > output/gul_S1_summarycalc.csv & kpid6=$!
