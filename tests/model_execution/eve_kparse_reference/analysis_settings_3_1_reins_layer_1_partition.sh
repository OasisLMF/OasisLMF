...
summarycalc -m -f -p input/RI_1 -1 fifo/ri_S1_summary_P2 < fifo/ri_P2 &
...
( fmcalc -a2 < fifo/lb_il_P1 | tee fifo/il_P1 | fmcalc -a2 -p input/RI_1 -n - > fifo/ri_P1 ) & pid31=$!
( fmcalc -a2 < fifo/lb_il_P2 | tee fifo/il_P2 | fmcalc -a2 -p input/RI_1 -n - > fifo/ri_P2 ) & pid32=$!
