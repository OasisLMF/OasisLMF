...
( fmcalc -a2 < fifo/lb_il_P1 | tee fifo/il_P1 | fmcalc -a2 -p input/RI_1 -n - > fifo/ri_P1 ) & pid19=$!
( fmcalc -a2 < fifo/lb_il_P2 | tee fifo/il_P2 | fmcalc -a2 -p input/RI_1 -n - > fifo/ri_P2 ) & pid20=$!
