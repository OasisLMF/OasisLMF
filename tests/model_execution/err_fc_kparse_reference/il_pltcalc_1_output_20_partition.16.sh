...
pltcalc -s < fifo/il_S1_summarypltcalc_P17 > work/kat/il_S1_pltcalc_P17 & pid1=$!
tee < fifo/il_S1_summary_P17 fifo/il_S1_summarypltcalc_P17 > /dev/null & pid2=$!
...
# --- Do insured loss computes ---
pltcalc -s < il_S1_summarypltcalc_P17 > work/full_correlation/kat/il_S1_pltcalc_P17 & pid1=$!
tee < il_S1_summary_P17 il_S1_summarypltcalc_P17 > /dev/null & pid2=$!
