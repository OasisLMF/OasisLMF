...
( ( tee < fifo/full_correlation/gul_fc_P1 fifo/full_correlation/gul_P1  | fmcalc -a2 | tee fifo/full_correlation/il_P1 | fmcalc -a3 -p RI_1 -n - > fifo/full_correlation/ri_P1 ) 2>> $LOG_DIR/stderror.err ) & pid19=$!
( ( eve 1 1 | getmodel | gulcalc -S0 -L0 -r -j fifo/full_correlation/gul_fc_P1 -a1 -i - | tee fifo/gul_P1 | fmcalc -a2 | tee fifo/il_P1 | fmcalc -a3 -p RI_1 -n - > fifo/ri_P1 ) 2>> $LOG_DIR/stderror.err ) & pid20=$!
