...
tee < fifo/il_S1_summary_P14 fifo/il_S1_summaryeltcalc_P14 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P14 < fifo/il_P14 ) 2>> log/stderror.err  &

( eve 14 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P14 -a1 -i - | fmcalc -a2 > fifo/il_P14  ) 2>> log/stderror.err &
...
tee < il_S1_summary_P14 il_S1_summaryeltcalc_P14 > /dev/null & pid2=$!
