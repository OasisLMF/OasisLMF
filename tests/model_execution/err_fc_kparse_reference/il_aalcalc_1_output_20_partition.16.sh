...
# --- Do insured loss computes ---
tee < fifo/full_correlation/il_S1_summary_P17 work/full_correlation/il_S1_summaryaalcalc/P17.bin > /dev/null & pid3=$!
tee < fifo/full_correlation/il_S1_summary_P17.idx work/full_correlation/il_S1_summaryaalcalc/P17.idx > /dev/null & pid4=$!
