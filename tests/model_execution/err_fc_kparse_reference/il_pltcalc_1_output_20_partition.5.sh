...
( pltcalc -H < fifo/il_S1_pltcalc_P6 > work/kat/il_S1_pltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid1=$!
...
# --- Do insured loss computes ---
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P6 > work/full_correlation/kat/il_S1_pltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid3=$!
tee < fifo/full_correlation/il_S1_summary_P6 fifo/full_correlation/il_S1_pltcalc_P6 > /dev/null & pid4=$!
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P6 < fifo/full_correlation/il_P6 ) 2>> $LOG_DIR/stderror.err  &

( ( fmcalc -a2 < fifo/full_correlation/gul_fc_P6 > fifo/full_correlation/il_P6 ) 2>> $LOG_DIR/stderror.err ) & pid5=$!
( ( eve 6 20 | getmodel | gulcalc -S100 -L100 -r -j fifo/full_correlation/gul_fc_P6 -a1 -i - | fmcalc -a2 > fifo/il_P6  ) 2>> $LOG_DIR/stderror.err ) & pid6=$!
