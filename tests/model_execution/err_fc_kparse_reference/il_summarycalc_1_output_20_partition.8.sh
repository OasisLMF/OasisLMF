...
( summarycalctocsv -s < fifo/il_S1_summarycalc_P9 > work/kat/il_S1_summarycalc_P9 ) 2>> $LOG_DIR/stderror.err & pid1=$!
...
# --- Do insured loss computes ---
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P9 > work/full_correlation/kat/il_S1_summarycalc_P9 ) 2>> $LOG_DIR/stderror.err & pid3=$!
