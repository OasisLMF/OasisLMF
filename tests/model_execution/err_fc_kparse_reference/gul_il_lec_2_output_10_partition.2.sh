...
( eve 3 10 | getmodel | gulcalc -S0 -L0 -r -j gul_P3 -a1 -i - | tee fifo/gul_P3 | fmcalc -a2 > fifo/il_P3  ) 2>> log/stderror.err &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8 $pid9 $pid10 $pid11 $pid12 $pid13 $pid14 $pid15 $pid16

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P3 > il_P3 ) 2>> log/stderror.err & fcpid1=$!
...
( summarycalc -f  -1 il_S1_summary_P3 -2 il_S2_summary_P3 < il_P3 ) 2>> log/stderror.err  &
...
( summarycalc -i  -1 gul_S1_summary_P3 -2 gul_S2_summary_P3 < gul_P3 ) 2>> log/stderror.err  &
