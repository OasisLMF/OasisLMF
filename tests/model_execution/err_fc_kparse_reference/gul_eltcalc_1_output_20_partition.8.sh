...
eltcalc -s < fifo/gul_S1_summaryeltcalc_P9 > work/kat/gul_S1_eltcalc_P9 & pid1=$!
tee < fifo/gul_S1_summary_P9 fifo/gul_S1_summaryeltcalc_P9 > /dev/null & pid2=$!
( summarycalc -i  -1 fifo/gul_S1_summary_P9 < fifo/gul_P9 ) 2>> log/stderror.err  &

( eve 9 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P9 -a1 -i - > fifo/gul_P9  ) 2>> log/stderror.err &
...
# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P9 > work/full_correlation/kat/gul_S1_eltcalc_P9 & pid1=$!
tee < gul_S1_summary_P9 gul_S1_summaryeltcalc_P9 > /dev/null & pid2=$!
( summarycalc -i  -1 gul_S1_summary_P9 < gul_P9 ) 2>> log/stderror.err  &
