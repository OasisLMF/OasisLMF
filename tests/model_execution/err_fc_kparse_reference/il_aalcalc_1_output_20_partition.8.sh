...
# --- Do insured loss computes ---
tee < fifo/full_correlation/il_S1_summary_P9 work/full_correlation/il_S1_summaryaalcalc/P9.bin > /dev/null & pid3=$!
tee < fifo/full_correlation/il_S1_summary_P9.idx work/full_correlation/il_S1_summaryaalcalc/P9.idx > /dev/null & pid4=$!
