...
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P4 > work/kat/il_S1_summarycalc_P4 & pid1=$!
tee < fifo/il_S1_summary_P4 fifo/il_S1_summarysummarycalc_P4 > /dev/null & pid2=$!
