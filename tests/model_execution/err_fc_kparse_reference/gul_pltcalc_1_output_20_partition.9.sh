...
pltcalc -s < fifo/gul_S1_summarypltcalc_P10 > work/kat/gul_S1_pltcalc_P10 & pid1=$!
tee < fifo/gul_S1_summary_P10 fifo/gul_S1_summarypltcalc_P10 > /dev/null & pid2=$!
( summarycalc -i  -1 fifo/gul_S1_summary_P10 < fifo/gul_P10 ) 2>> log/stderror.err  &

( eve 10 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P10 -a1 -i - > fifo/gul_P10  ) 2>> log/stderror.err &
...
# --- Do ground up loss computes ---
pltcalc -s < gul_S1_summarypltcalc_P10 > work/full_correlation/kat/gul_S1_pltcalc_P10 & pid1=$!
tee < gul_S1_summary_P10 gul_S1_summarypltcalc_P10 > /dev/null & pid2=$!
( summarycalc -i  -1 gul_S1_summary_P10 < gul_P10 ) 2>> log/stderror.err  &
...
kat work/full_correlation/kat/gul_S1_pltcalc_P10 > output/full_correlation/gul_S1_pltcalc.csv & kpid2=$!
wait $kpid1 $kpid2
