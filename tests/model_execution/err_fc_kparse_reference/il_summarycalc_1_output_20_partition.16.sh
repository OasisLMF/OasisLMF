...
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P17 > work/kat/il_S1_summarycalc_P17 & pid1=$!
tee < fifo/il_S1_summary_P17 fifo/il_S1_summarysummarycalc_P17 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P17 < fifo/il_P17 ) 2>> log/stderror.err  &

( eve 17 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P17 -a1 -i - | fmcalc -a2 > fifo/il_P17  ) 2>> log/stderror.err &
...
# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P17 > work/full_correlation/kat/il_S1_summarycalc_P17 & pid1=$!
tee < il_S1_summary_P17 il_S1_summarysummarycalc_P17 > /dev/null & pid2=$!
