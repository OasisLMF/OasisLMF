...
tee < il_S1_summary_P18 il_S1_summaryeltcalc_P18 > /dev/null & pid2=$!
...
kat work/full_correlation/kat/il_S1_eltcalc_P18 > output/full_correlation/il_S1_eltcalc.csv & kpid2=$!
wait $kpid1 $kpid2
