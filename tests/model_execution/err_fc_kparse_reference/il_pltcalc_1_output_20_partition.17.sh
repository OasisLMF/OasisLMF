...
pltcalc -s < fifo/il_S1_summarypltcalc_P18 > work/kat/il_S1_pltcalc_P18 & pid1=$!
tee < fifo/il_S1_summary_P18 fifo/il_S1_summarypltcalc_P18 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P18 < fifo/il_P18 ) 2>> log/stderror.err  &

( eve 18 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P18 -a1 -i - | fmcalc -a2 > fifo/il_P18  ) 2>> log/stderror.err &

wait $pid1 $pid2

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P18 > il_P18 ) 2>> log/stderror.err & fcpid1=$!

wait $fcpid1


# --- Do insured loss computes ---
pltcalc -s < il_S1_summarypltcalc_P18 > work/full_correlation/kat/il_S1_pltcalc_P18 & pid1=$!
tee < il_S1_summary_P18 il_S1_summarypltcalc_P18 > /dev/null & pid2=$!
( summarycalc -f  -1 il_S1_summary_P18 < il_P18 ) 2>> log/stderror.err  &
...
kat work/full_correlation/kat/il_S1_pltcalc_P18 > output/full_correlation/il_S1_pltcalc.csv & kpid2=$!
wait $kpid1 $kpid2
