...
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P15 > work/kat/il_S1_summarycalc_P15 & pid1=$!
tee < fifo/il_S1_summary_P15 fifo/il_S1_summarysummarycalc_P15 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P15 < fifo/il_P15 ) 2>> log/stderror.err  &

( eve 15 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P15 -a1 -i - | fmcalc -a2 > fifo/il_P15  ) 2>> log/stderror.err &

wait $pid1 $pid2

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P15 > il_P15 ) 2>> log/stderror.err & fcpid1=$!

wait $fcpid1


# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P15 > work/full_correlation/kat/il_S1_summarycalc_P15 & pid1=$!
tee < il_S1_summary_P15 il_S1_summarysummarycalc_P15 > /dev/null & pid2=$!
( summarycalc -f  -1 il_S1_summary_P15 < il_P15 ) 2>> log/stderror.err  &
