...
summarycalctocsv < fifo/full_correlation/gul_S1_summarysummarycalc_P1 > work/full_correlation/kat/gul_S1_summarycalc_P1 & pid1=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P2 > work/full_correlation/kat/gul_S1_summarycalc_P2 & pid2=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P3 > work/full_correlation/kat/gul_S1_summarycalc_P3 & pid3=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P4 > work/full_correlation/kat/gul_S1_summarycalc_P4 & pid4=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P5 > work/full_correlation/kat/gul_S1_summarycalc_P5 & pid5=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P6 > work/full_correlation/kat/gul_S1_summarycalc_P6 & pid6=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P7 > work/full_correlation/kat/gul_S1_summarycalc_P7 & pid7=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P8 > work/full_correlation/kat/gul_S1_summarycalc_P8 & pid8=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P9 > work/full_correlation/kat/gul_S1_summarycalc_P9 & pid9=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P10 > work/full_correlation/kat/gul_S1_summarycalc_P10 & pid10=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P11 > work/full_correlation/kat/gul_S1_summarycalc_P11 & pid11=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P12 > work/full_correlation/kat/gul_S1_summarycalc_P12 & pid12=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P13 > work/full_correlation/kat/gul_S1_summarycalc_P13 & pid13=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P14 > work/full_correlation/kat/gul_S1_summarycalc_P14 & pid14=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P15 > work/full_correlation/kat/gul_S1_summarycalc_P15 & pid15=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P16 > work/full_correlation/kat/gul_S1_summarycalc_P16 & pid16=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P17 > work/full_correlation/kat/gul_S1_summarycalc_P17 & pid17=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P18 > work/full_correlation/kat/gul_S1_summarycalc_P18 & pid18=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P19 > work/full_correlation/kat/gul_S1_summarycalc_P19 & pid19=$!
summarycalctocsv -s < fifo/full_correlation/gul_S1_summarysummarycalc_P20 > work/full_correlation/kat/gul_S1_summarycalc_P20 & pid20=$!

tee < fifo/full_correlation/gul_S1_summary_P1 fifo/full_correlation/gul_S1_summarysummarycalc_P1 > /dev/null & pid21=$!
tee < fifo/full_correlation/gul_S1_summary_P2 fifo/full_correlation/gul_S1_summarysummarycalc_P2 > /dev/null & pid22=$!
tee < fifo/full_correlation/gul_S1_summary_P3 fifo/full_correlation/gul_S1_summarysummarycalc_P3 > /dev/null & pid23=$!
tee < fifo/full_correlation/gul_S1_summary_P4 fifo/full_correlation/gul_S1_summarysummarycalc_P4 > /dev/null & pid24=$!
tee < fifo/full_correlation/gul_S1_summary_P5 fifo/full_correlation/gul_S1_summarysummarycalc_P5 > /dev/null & pid25=$!
tee < fifo/full_correlation/gul_S1_summary_P6 fifo/full_correlation/gul_S1_summarysummarycalc_P6 > /dev/null & pid26=$!
tee < fifo/full_correlation/gul_S1_summary_P7 fifo/full_correlation/gul_S1_summarysummarycalc_P7 > /dev/null & pid27=$!
tee < fifo/full_correlation/gul_S1_summary_P8 fifo/full_correlation/gul_S1_summarysummarycalc_P8 > /dev/null & pid28=$!
tee < fifo/full_correlation/gul_S1_summary_P9 fifo/full_correlation/gul_S1_summarysummarycalc_P9 > /dev/null & pid29=$!
tee < fifo/full_correlation/gul_S1_summary_P10 fifo/full_correlation/gul_S1_summarysummarycalc_P10 > /dev/null & pid30=$!
tee < fifo/full_correlation/gul_S1_summary_P11 fifo/full_correlation/gul_S1_summarysummarycalc_P11 > /dev/null & pid31=$!
tee < fifo/full_correlation/gul_S1_summary_P12 fifo/full_correlation/gul_S1_summarysummarycalc_P12 > /dev/null & pid32=$!
tee < fifo/full_correlation/gul_S1_summary_P13 fifo/full_correlation/gul_S1_summarysummarycalc_P13 > /dev/null & pid33=$!
tee < fifo/full_correlation/gul_S1_summary_P14 fifo/full_correlation/gul_S1_summarysummarycalc_P14 > /dev/null & pid34=$!
tee < fifo/full_correlation/gul_S1_summary_P15 fifo/full_correlation/gul_S1_summarysummarycalc_P15 > /dev/null & pid35=$!
tee < fifo/full_correlation/gul_S1_summary_P16 fifo/full_correlation/gul_S1_summarysummarycalc_P16 > /dev/null & pid36=$!
tee < fifo/full_correlation/gul_S1_summary_P17 fifo/full_correlation/gul_S1_summarysummarycalc_P17 > /dev/null & pid37=$!
tee < fifo/full_correlation/gul_S1_summary_P18 fifo/full_correlation/gul_S1_summarysummarycalc_P18 > /dev/null & pid38=$!
tee < fifo/full_correlation/gul_S1_summary_P19 fifo/full_correlation/gul_S1_summarysummarycalc_P19 > /dev/null & pid39=$!
tee < fifo/full_correlation/gul_S1_summary_P20 fifo/full_correlation/gul_S1_summarysummarycalc_P20 > /dev/null & pid40=$!
