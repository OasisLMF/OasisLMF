...
summarycalctocsv -s < fifo/gul_S1_summarysummarycalc_P10 > work/kat/gul_S1_summarycalc_P10 & pid1=$!
tee < fifo/gul_S1_summary_P10 fifo/gul_S1_summarysummarycalc_P10 > /dev/null & pid2=$!
