...
( pltcalc -H < fifo/il_S1_pltcalc_P5 > work/kat/il_S1_pltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid1=$!
...
# --- Do insured loss computes ---
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P5 > work/full_correlation/kat/il_S1_pltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid3=$!
tee < fifo/full_correlation/il_S1_summary_P5 fifo/full_correlation/il_S1_pltcalc_P5 > /dev/null & pid4=$!
