...
( eltcalc -s < fifo/il_S1_eltcalc_P40 > work/kat/il_S1_eltcalc_P40 ) 2>> log/stderror.err & pid1=$!
( summarycalctocsv -s < fifo/il_S1_summarycalc_P40 > work/kat/il_S1_summarycalc_P40 ) 2>> log/stderror.err & pid2=$!
( pltcalc -s < fifo/il_S1_pltcalc_P40 > work/kat/il_S1_pltcalc_P40 ) 2>> log/stderror.err & pid3=$!
...
tee < fifo/il_S1_summary_P40.idx work/il_S1_summaryleccalc/P40.idx > /dev/null & pid5=$!
( summarycalc -m -f  -1 fifo/il_S1_summary_P40 < fifo/il_P40 ) 2>> log/stderror.err  &

# --- Do ground up loss computes ---
( eltcalc -s < fifo/gul_S1_eltcalc_P40 > work/kat/gul_S1_eltcalc_P40 ) 2>> log/stderror.err & pid6=$!
( summarycalctocsv -s < fifo/gul_S1_summarycalc_P40 > work/kat/gul_S1_summarycalc_P40 ) 2>> log/stderror.err & pid7=$!
( pltcalc -s < fifo/gul_S1_pltcalc_P40 > work/kat/gul_S1_pltcalc_P40 ) 2>> log/stderror.err & pid8=$!
...
tee < fifo/gul_S1_summary_P40.idx work/gul_S1_summaryleccalc/P40.idx > /dev/null & pid10=$!
( summarycalc -m -i  -1 fifo/gul_S1_summary_P40 < fifo/gul_P40 ) 2>> log/stderror.err  &

# --- Do insured loss computes ---
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P40 > work/full_correlation/kat/il_S1_eltcalc_P40 ) 2>> log/stderror.err & pid11=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P40 > work/full_correlation/kat/il_S1_summarycalc_P40 ) 2>> log/stderror.err & pid12=$!
( pltcalc -s < fifo/full_correlation/il_S1_pltcalc_P40 > work/full_correlation/kat/il_S1_pltcalc_P40 ) 2>> log/stderror.err & pid13=$!
tee < fifo/full_correlation/il_S1_summary_P40 fifo/full_correlation/il_S1_eltcalc_P40 fifo/full_correlation/il_S1_summarycalc_P40 fifo/full_correlation/il_S1_pltcalc_P40 work/full_correlation/il_S1_summaryaalcalc/P40.bin work/full_correlation/il_S1_summaryleccalc/P40.bin > /dev/null & pid14=$!
tee < fifo/full_correlation/il_S1_summary_P40.idx work/full_correlation/il_S1_summaryleccalc/P40.idx > /dev/null & pid15=$!
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P40 < fifo/full_correlation/il_P40 ) 2>> log/stderror.err  &

# --- Do ground up loss computes ---
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P40 > work/full_correlation/kat/gul_S1_eltcalc_P40 ) 2>> log/stderror.err & pid16=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P40 > work/full_correlation/kat/gul_S1_summarycalc_P40 ) 2>> log/stderror.err & pid17=$!
( pltcalc -s < fifo/full_correlation/gul_S1_pltcalc_P40 > work/full_correlation/kat/gul_S1_pltcalc_P40 ) 2>> log/stderror.err & pid18=$!
tee < fifo/full_correlation/gul_S1_summary_P40 fifo/full_correlation/gul_S1_eltcalc_P40 fifo/full_correlation/gul_S1_summarycalc_P40 fifo/full_correlation/gul_S1_pltcalc_P40 work/full_correlation/gul_S1_summaryaalcalc/P40.bin work/full_correlation/gul_S1_summaryleccalc/P40.bin > /dev/null & pid19=$!
tee < fifo/full_correlation/gul_S1_summary_P40.idx work/full_correlation/gul_S1_summaryleccalc/P40.idx > /dev/null & pid20=$!
