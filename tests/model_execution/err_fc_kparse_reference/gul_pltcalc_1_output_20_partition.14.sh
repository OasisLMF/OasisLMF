...
( eve 15 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P15 -a1 -i - > fifo/gul_P15  ) 2>> log/stderror.err &
...
# --- Do ground up loss computes ---
pltcalc -s < gul_S1_summarypltcalc_P15 > work/full_correlation/kat/gul_S1_pltcalc_P15 & pid1=$!
tee < gul_S1_summary_P15 gul_S1_summarypltcalc_P15 > /dev/null & pid2=$!
( summarycalc -i  -1 gul_S1_summary_P15 < gul_P15 ) 2>> log/stderror.err  &
