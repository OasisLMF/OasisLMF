...
# --- Do insured loss computes ---
tee < fifo/full_correlation/il_S1_summary_P19 work/full_correlation/il_S1_summaryaalcalc/P19.bin > /dev/null & pid3=$!
tee < fifo/full_correlation/il_S1_summary_P19.idx work/full_correlation/il_S1_summaryaalcalc/P19.idx > /dev/null & pid4=$!
