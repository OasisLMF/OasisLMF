...
( summarycalctocsv -s < fifo/gul_S1_summarycalc_P16 > work/kat/gul_S1_summarycalc_P16 ) 2>> $LOG_DIR/stderror.err & pid1=$!
...
# --- Do ground up loss computes ---
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P16 > work/full_correlation/kat/gul_S1_summarycalc_P16 ) 2>> $LOG_DIR/stderror.err & pid3=$!
tee < fifo/full_correlation/gul_S1_summary_P16 fifo/full_correlation/gul_S1_summarycalc_P16 > /dev/null & pid4=$!
( summarycalc -m -i  -1 fifo/full_correlation/gul_S1_summary_P16 < fifo/full_correlation/gul_P16 ) 2>> $LOG_DIR/stderror.err  &

( ( eve 16 20 | getmodel | gulcalc -S100 -L100 -r -j fifo/full_correlation/gul_P16 -a1 -i - > fifo/gul_P16  ) 2>> $LOG_DIR/stderror.err ) &  pid5=$!
