...
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P18 > work/kat/il_S1_summarycalc_P18 & pid1=$!
tee < fifo/il_S1_summary_P18 fifo/il_S1_summarysummarycalc_P18 > /dev/null & pid2=$!
...
# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P18 > work/full_correlation/kat/il_S1_summarycalc_P18 & pid1=$!
tee < il_S1_summary_P18 il_S1_summarysummarycalc_P18 > /dev/null & pid2=$!
