...
( leccalc -r -Kgul_S1_summaryleccalc -W output/gul_S1_leccalc_wheatsheaf_aep.csv ) 2>> log/stderror.err & lpid1=$!
( leccalc -r -Kfull_correlation/gul_S1_summaryleccalc -W output/full_correlation/gul_S1_leccalc_wheatsheaf_aep.csv ) 2>> log/stderror.err & lpid2=$!
wait $lpid1 $lpid2
