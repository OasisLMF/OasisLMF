...
summarycalctocsv -s < fifo/gul_S1_summarysummarycalc_P19 > work/kat/gul_S1_summarycalc_P19 & pid1=$!
tee < fifo/gul_S1_summary_P19 fifo/gul_S1_summarysummarycalc_P19 > /dev/null & pid2=$!
...
# --- Do ground up loss computes ---
summarycalctocsv -s < gul_S1_summarysummarycalc_P19 > work/full_correlation/kat/gul_S1_summarycalc_P19 & pid1=$!
tee < gul_S1_summary_P19 gul_S1_summarysummarycalc_P19 > /dev/null & pid2=$!
