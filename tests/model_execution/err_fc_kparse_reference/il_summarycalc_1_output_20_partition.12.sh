...
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P13 > work/kat/il_S1_summarycalc_P13 & pid1=$!
tee < fifo/il_S1_summary_P13 fifo/il_S1_summarysummarycalc_P13 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P13 < fifo/il_P13 ) 2>> log/stderror.err  &

( eve 13 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P13 -a1 -i - | fmcalc -a2 > fifo/il_P13  ) 2>> log/stderror.err &
...
# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P13 > work/full_correlation/kat/il_S1_summarycalc_P13 & pid1=$!
tee < il_S1_summary_P13 il_S1_summarysummarycalc_P13 > /dev/null & pid2=$!
