...
mkfifo gul_S1_summaryeltcalc_P20
mkfifo gul_S1_eltcalc_P20
...
mkfifo il_S1_summarypltcalc_P20
mkfifo il_S1_pltcalc_P20
...
( eve 20 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P20 -a1 -i - | tee fifo/gul_P20 | fmcalc -a2 > fifo/il_P20  ) 2>> log/stderror.err &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P20 > il_P20 ) 2>> log/stderror.err & fcpid1=$!
...
summarycalctocsv -s < il_S1_summarysummarycalc_P20 > work/full_correlation/kat/il_S1_summarycalc_P20 & pid2=$!
pltcalc -s < il_S1_summarypltcalc_P20 > work/full_correlation/kat/il_S1_pltcalc_P20 & pid3=$!
tee < il_S1_summary_P20 il_S1_summaryeltcalc_P20 il_S1_summarypltcalc_P20 il_S1_summarysummarycalc_P20 work/full_correlation/il_S1_summaryaalcalc/P20.bin work/full_correlation/il_S1_summaryleccalc/P20.bin > /dev/null & pid4=$!
( summarycalc -f  -1 il_S1_summary_P20 < il_P20 ) 2>> log/stderror.err  &

# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P20 > work/full_correlation/kat/gul_S1_eltcalc_P20 & pid5=$!
summarycalctocsv -s < gul_S1_summarysummarycalc_P20 > work/full_correlation/kat/gul_S1_summarycalc_P20 & pid6=$!
pltcalc -s < gul_S1_summarypltcalc_P20 > work/full_correlation/kat/gul_S1_pltcalc_P20 & pid7=$!
tee < gul_S1_summary_P20 gul_S1_summaryeltcalc_P20 gul_S1_summarypltcalc_P20 gul_S1_summarysummarycalc_P20 work/full_correlation/gul_S1_summaryaalcalc/P20.bin work/full_correlation/gul_S1_summaryleccalc/P20.bin > /dev/null & pid8=$!
( summarycalc -i  -1 gul_S1_summary_P20 < gul_P20 ) 2>> log/stderror.err  &
