...
( summarycalc -f -z -p RI_1 -1 fifo/ri_S1_summary_P1 < fifo/ri_P1 ) 2>> log/stderror.err  &
...
( eltcalc < fifo/full_correlation/ri_S1_eltcalc_P1 > work/full_correlation/kat/ri_S1_eltcalc_P1 ) 2>> log/stderror.err & pid13=$!
( summarycalctocsv < fifo/full_correlation/ri_S1_summarycalc_P1 > work/full_correlation/kat/ri_S1_summarycalc_P1 ) 2>> log/stderror.err & pid14=$!
( pltcalc < fifo/full_correlation/ri_S1_pltcalc_P1 > work/full_correlation/kat/ri_S1_pltcalc_P1 ) 2>> log/stderror.err & pid15=$!

tee < fifo/full_correlation/ri_S1_summary_P1 fifo/full_correlation/ri_S1_eltcalc_P1 fifo/full_correlation/ri_S1_summarycalc_P1 fifo/full_correlation/ri_S1_pltcalc_P1 work/full_correlation/ri_S1_summaryaalcalc/P1.bin work/full_correlation/ri_S1_summaryleccalc/P1.bin > /dev/null & pid16=$!

( summarycalc -f -z -p RI_1 -1 fifo/full_correlation/ri_S1_summary_P1 < fifo/full_correlation/ri_P1 ) 2>> log/stderror.err  &
...
tee < fifo/full_correlation/il_S1_summary_P1 fifo/full_correlation/il_S1_eltcalc_P1 fifo/full_correlation/il_S1_summarycalc_P1 fifo/full_correlation/il_S1_pltcalc_P1 work/full_correlation/il_S1_summaryaalcalc/P1.bin > /dev/null & pid20=$!
...
tee < fifo/full_correlation/gul_S1_summary_P1 fifo/full_correlation/gul_S1_eltcalc_P1 fifo/full_correlation/gul_S1_summarycalc_P1 fifo/full_correlation/gul_S1_pltcalc_P1 work/full_correlation/gul_S1_summaryaalcalc/P1.bin > /dev/null & pid24=$!
...
( aalcalc -Kfull_correlation/ri_S1_summaryaalcalc > output/full_correlation/ri_S1_aalcalc.csv ) 2>> log/stderror.err & lpid5=$!
( leccalc -r -Kfull_correlation/ri_S1_summaryleccalc -F output/full_correlation/ri_S1_leccalc_full_uncertainty_aep.csv -f output/full_correlation/ri_S1_leccalc_full_uncertainty_oep.csv -S output/full_correlation/ri_S1_leccalc_sample_mean_aep.csv -s output/full_correlation/ri_S1_leccalc_sample_mean_oep.csv -W output/full_correlation/ri_S1_leccalc_wheatsheaf_aep.csv -M output/full_correlation/ri_S1_leccalc_wheatsheaf_mean_aep.csv -m output/full_correlation/ri_S1_leccalc_wheatsheaf_mean_oep.csv -w output/full_correlation/ri_S1_leccalc_wheatsheaf_oep.csv ) 2>> log/stderror.err & lpid6=$!
( aalcalc -Kfull_correlation/il_S1_summaryaalcalc > output/full_correlation/il_S1_aalcalc.csv ) 2>> log/stderror.err & lpid7=$!
( aalcalc -Kfull_correlation/gul_S1_summaryaalcalc > output/full_correlation/gul_S1_aalcalc.csv ) 2>> log/stderror.err & lpid8=$!
