...
pltcalc -s < fifo/il_S1_summarypltcalc_P7 > work/kat/il_S1_pltcalc_P7 & pid1=$!
tee < fifo/il_S1_summary_P7 fifo/il_S1_summarypltcalc_P7 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P7 < fifo/il_P7 ) 2>> log/stderror.err  &

( eve 7 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P7 -a1 -i - | fmcalc -a2 > fifo/il_P7  ) 2>> log/stderror.err &
...
# --- Do insured loss computes ---
pltcalc -s < il_S1_summarypltcalc_P7 > work/full_correlation/kat/il_S1_pltcalc_P7 & pid1=$!
tee < il_S1_summary_P7 il_S1_summarypltcalc_P7 > /dev/null & pid2=$!
