...
eltcalc -s < fifo/il_S1_summaryeltcalc_P37 > work/kat/il_S1_eltcalc_P37 & pid1=$!
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P37 > work/kat/il_S1_summarycalc_P37 & pid2=$!
pltcalc -s < fifo/il_S1_summarypltcalc_P37 > work/kat/il_S1_pltcalc_P37 & pid3=$!
tee < fifo/il_S1_summary_P37 fifo/il_S1_summaryeltcalc_P37 fifo/il_S1_summarypltcalc_P37 fifo/il_S1_summarysummarycalc_P37 work/il_S1_summaryaalcalc/P37.bin work/il_S1_summaryleccalc/P37.bin > /dev/null & pid4=$!
( summarycalc -f  -1 fifo/il_S1_summary_P37 < fifo/il_P37 ) 2>> log/stderror.err  &

# --- Do ground up loss computes ---
eltcalc -s < fifo/gul_S1_summaryeltcalc_P37 > work/kat/gul_S1_eltcalc_P37 & pid5=$!
summarycalctocsv -s < fifo/gul_S1_summarysummarycalc_P37 > work/kat/gul_S1_summarycalc_P37 & pid6=$!
pltcalc -s < fifo/gul_S1_summarypltcalc_P37 > work/kat/gul_S1_pltcalc_P37 & pid7=$!
tee < fifo/gul_S1_summary_P37 fifo/gul_S1_summaryeltcalc_P37 fifo/gul_S1_summarypltcalc_P37 fifo/gul_S1_summarysummarycalc_P37 work/gul_S1_summaryaalcalc/P37.bin work/gul_S1_summaryleccalc/P37.bin > /dev/null & pid8=$!
( summarycalc -i  -1 fifo/gul_S1_summary_P37 < fifo/gul_P37 ) 2>> log/stderror.err  &

( eve 37 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P37 -a1 -i - | tee fifo/gul_P37 | fmcalc -a2 > fifo/il_P37  ) 2>> log/stderror.err &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P37 > il_P37 ) 2>> log/stderror.err & fcpid1=$!
...
( summarycalc -f  -1 il_S1_summary_P37 < il_P37 ) 2>> log/stderror.err  &
...
( summarycalc -i  -1 gul_S1_summary_P37 < gul_P37 ) 2>> log/stderror.err  &
