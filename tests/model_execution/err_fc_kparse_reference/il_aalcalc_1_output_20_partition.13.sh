...
# --- Do insured loss computes ---
tee < fifo/full_correlation/il_S1_summary_P14 work/full_correlation/il_S1_summaryaalcalc/P14.bin > /dev/null & pid3=$!
tee < fifo/full_correlation/il_S1_summary_P14.idx work/full_correlation/il_S1_summaryaalcalc/P14.idx > /dev/null & pid4=$!
