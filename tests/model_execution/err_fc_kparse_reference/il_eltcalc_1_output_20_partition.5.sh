...
( eve 6 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P6 -a1 -i - | fmcalc -a2 > fifo/il_P6  ) 2>> log/stderror.err &
...
tee < il_S1_summary_P6 il_S1_summaryeltcalc_P6 > /dev/null & pid2=$!
( summarycalc -f  -1 il_S1_summary_P6 < il_P6 ) 2>> log/stderror.err  &
