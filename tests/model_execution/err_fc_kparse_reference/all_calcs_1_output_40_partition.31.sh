...
( eve 32 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P32 -a1 -i - | tee fifo/gul_P32 | fmcalc -a2 > fifo/il_P32  ) 2>> log/stderror.err &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P32 > il_P32 ) 2>> log/stderror.err & fcpid1=$!
...
( summarycalc -f  -1 il_S1_summary_P32 < il_P32 ) 2>> log/stderror.err  &
...
( summarycalc -i  -1 gul_S1_summary_P32 < gul_P32 ) 2>> log/stderror.err  &
