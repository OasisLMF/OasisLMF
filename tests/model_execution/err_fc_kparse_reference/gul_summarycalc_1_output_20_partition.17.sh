...
( summarycalctocsv -s < fifo/gul_S1_summarycalc_P18 > work/kat/gul_S1_summarycalc_P18 ) 2>> $LOG_DIR/stderror.err & pid1=$!
...
# --- Do ground up loss computes ---
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P18 > work/full_correlation/kat/gul_S1_summarycalc_P18 ) 2>> $LOG_DIR/stderror.err & pid3=$!
