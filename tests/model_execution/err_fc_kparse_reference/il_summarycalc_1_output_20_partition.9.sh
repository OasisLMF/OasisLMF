...
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P10 > work/kat/il_S1_summarycalc_P10 & pid1=$!
tee < fifo/il_S1_summary_P10 fifo/il_S1_summarysummarycalc_P10 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P10 < fifo/il_P10 ) 2>> log/stderror.err  &

( eve 10 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P10 -a1 -i - | fmcalc -a2 > fifo/il_P10  ) 2>> log/stderror.err &
...
# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P10 > work/full_correlation/kat/il_S1_summarycalc_P10 & pid1=$!
tee < il_S1_summary_P10 il_S1_summarysummarycalc_P10 > /dev/null & pid2=$!
( summarycalc -f  -1 il_S1_summary_P10 < il_P10 ) 2>> log/stderror.err  &
