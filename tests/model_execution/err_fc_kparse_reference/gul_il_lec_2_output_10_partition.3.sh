...
( eve 4 10 | getmodel | gulcalc -S0 -L0 -r -j gul_P4 -a1 -i - | tee fifo/gul_P4 | fmcalc -a2 > fifo/il_P4  ) 2>> log/stderror.err &
...
( summarycalc -f  -1 il_S1_summary_P4 -2 il_S2_summary_P4 < il_P4 ) 2>> log/stderror.err  &
...
( summarycalc -i  -1 gul_S1_summary_P4 -2 gul_S2_summary_P4 < gul_P4 ) 2>> log/stderror.err  &
