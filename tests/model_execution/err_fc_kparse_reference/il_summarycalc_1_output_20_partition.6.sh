...
summarycalctocsv -s < fifo/il_S1_summarysummarycalc_P7 > work/kat/il_S1_summarycalc_P7 & pid1=$!
tee < fifo/il_S1_summary_P7 fifo/il_S1_summarysummarycalc_P7 > /dev/null & pid2=$!
