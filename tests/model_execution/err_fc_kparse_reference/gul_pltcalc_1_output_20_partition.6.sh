...
( pltcalc -H < fifo/gul_S1_pltcalc_P7 > work/kat/gul_S1_pltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid1=$!
...
# --- Do ground up loss computes ---
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P7 > work/full_correlation/kat/gul_S1_pltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid3=$!
tee < fifo/full_correlation/gul_S1_summary_P7 fifo/full_correlation/gul_S1_pltcalc_P7 > /dev/null & pid4=$!
