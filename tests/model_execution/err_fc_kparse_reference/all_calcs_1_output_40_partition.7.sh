...
( eve 8 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P8 -a1 -i - | tee fifo/gul_P8 | fmcalc -a2 > fifo/il_P8  ) 2>> log/stderror.err &
...
tee < il_S1_summary_P8 il_S1_summaryeltcalc_P8 il_S1_summarypltcalc_P8 il_S1_summarysummarycalc_P8 work/full_correlation/il_S1_summaryaalcalc/P8.bin work/full_correlation/il_S1_summaryleccalc/P8.bin > /dev/null & pid4=$!
( summarycalc -f  -1 il_S1_summary_P8 < il_P8 ) 2>> log/stderror.err  &

# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P8 > work/full_correlation/kat/gul_S1_eltcalc_P8 & pid5=$!
summarycalctocsv -s < gul_S1_summarysummarycalc_P8 > work/full_correlation/kat/gul_S1_summarycalc_P8 & pid6=$!
pltcalc -s < gul_S1_summarypltcalc_P8 > work/full_correlation/kat/gul_S1_pltcalc_P8 & pid7=$!
tee < gul_S1_summary_P8 gul_S1_summaryeltcalc_P8 gul_S1_summarypltcalc_P8 gul_S1_summarysummarycalc_P8 work/full_correlation/gul_S1_summaryaalcalc/P8.bin work/full_correlation/gul_S1_summaryleccalc/P8.bin > /dev/null & pid8=$!
( summarycalc -i  -1 gul_S1_summary_P8 < gul_P8 ) 2>> log/stderror.err  &
