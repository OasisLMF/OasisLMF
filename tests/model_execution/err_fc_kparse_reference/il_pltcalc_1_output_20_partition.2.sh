...
( eve 3 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P3 -a1 -i - | fmcalc -a2 > fifo/il_P3  ) 2>> log/stderror.err &
...
# --- Do insured loss computes ---
pltcalc -s < il_S1_summarypltcalc_P3 > work/full_correlation/kat/il_S1_pltcalc_P3 & pid1=$!
tee < il_S1_summary_P3 il_S1_summarypltcalc_P3 > /dev/null & pid2=$!
