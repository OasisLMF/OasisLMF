...
( eve 39 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P39 -a1 -i - | tee fifo/gul_P39 | fmcalc -a2 > fifo/il_P39  ) 2>> log/stderror.err &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P39 > il_P39 ) 2>> log/stderror.err & fcpid1=$!
...
( summarycalc -f  -1 il_S1_summary_P39 < il_P39 ) 2>> log/stderror.err  &
...
( summarycalc -i  -1 gul_S1_summary_P39 < gul_P39 ) 2>> log/stderror.err  &
