...
pltcalc -s < fifo/gul_S1_summarypltcalc_P16 > work/kat/gul_S1_pltcalc_P16 & pid1=$!
tee < fifo/gul_S1_summary_P16 fifo/gul_S1_summarypltcalc_P16 > /dev/null & pid2=$!
( summarycalc -i  -1 fifo/gul_S1_summary_P16 < fifo/gul_P16 ) 2>> log/stderror.err  &

( eve 16 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P16 -a1 -i - > fifo/gul_P16  ) 2>> log/stderror.err &
...
# --- Do ground up loss computes ---
pltcalc -s < gul_S1_summarypltcalc_P16 > work/full_correlation/kat/gul_S1_pltcalc_P16 & pid1=$!
tee < gul_S1_summary_P16 gul_S1_summarypltcalc_P16 > /dev/null & pid2=$!
( summarycalc -i  -1 gul_S1_summary_P16 < gul_P16 ) 2>> log/stderror.err  &
...
kat work/full_correlation/kat/gul_S1_pltcalc_P16 > output/full_correlation/gul_S1_pltcalc.csv & kpid2=$!
wait $kpid1 $kpid2
