...
tee < fifo/il_S1_summary_P9 fifo/il_S1_summaryeltcalc_P9 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P9 < fifo/il_P9 ) 2>> log/stderror.err  &

( eve 9 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P9 -a1 -i - | fmcalc -a2 > fifo/il_P9  ) 2>> log/stderror.err &
...
tee < il_S1_summary_P9 il_S1_summaryeltcalc_P9 > /dev/null & pid2=$!
( summarycalc -f  -1 il_S1_summary_P9 < il_P9 ) 2>> log/stderror.err  &
