...
find work/ \( -name '*P26[^0-9]*' -o -name '*P26' \) -exec rm -R -f {} +
mkdir -p work/kat/
...
( eltcalc -s < fifo/il_S1_eltcalc_P26 > work/kat/il_S1_eltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid1=$!
( summarycalctocsv -s < fifo/il_S1_summarycalc_P26 > work/kat/il_S1_summarycalc_P26 ) 2>> $LOG_DIR/stderror.err & pid2=$!
( pltcalc -H < fifo/il_S1_pltcalc_P26 > work/kat/il_S1_pltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid3=$!
...
( eltcalc -s < fifo/gul_S1_eltcalc_P26 > work/kat/gul_S1_eltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid6=$!
( summarycalctocsv -s < fifo/gul_S1_summarycalc_P26 > work/kat/gul_S1_summarycalc_P26 ) 2>> $LOG_DIR/stderror.err & pid7=$!
( pltcalc -H < fifo/gul_S1_pltcalc_P26 > work/kat/gul_S1_pltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid8=$!
...
# --- Do insured loss computes ---
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P26 > work/full_correlation/kat/il_S1_eltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid11=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P26 > work/full_correlation/kat/il_S1_summarycalc_P26 ) 2>> $LOG_DIR/stderror.err & pid12=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P26 > work/full_correlation/kat/il_S1_pltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid13=$!
...
tee < fifo/full_correlation/il_S1_summary_P26.idx work/full_correlation/il_S1_summaryaalcalc/P26.idx work/full_correlation/il_S1_summaryleccalc/P26.idx > /dev/null & pid15=$!
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P26 < fifo/full_correlation/il_P26 ) 2>> $LOG_DIR/stderror.err  &

# --- Do ground up loss computes ---
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P26 > work/full_correlation/kat/gul_S1_eltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid16=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P26 > work/full_correlation/kat/gul_S1_summarycalc_P26 ) 2>> $LOG_DIR/stderror.err & pid17=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P26 > work/full_correlation/kat/gul_S1_pltcalc_P26 ) 2>> $LOG_DIR/stderror.err & pid18=$!
...
tee < fifo/full_correlation/gul_S1_summary_P26.idx work/full_correlation/gul_S1_summaryaalcalc/P26.idx work/full_correlation/gul_S1_summaryleccalc/P26.idx > /dev/null & pid20=$!
