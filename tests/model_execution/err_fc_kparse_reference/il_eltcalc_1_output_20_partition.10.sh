...
tee < fifo/il_S1_summary_P11 fifo/il_S1_summaryeltcalc_P11 > /dev/null & pid2=$!
( summarycalc -f  -1 fifo/il_S1_summary_P11 < fifo/il_P11 ) 2>> log/stderror.err  &

( eve 11 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P11 -a1 -i - | fmcalc -a2 > fifo/il_P11  ) 2>> log/stderror.err &
...
tee < il_S1_summary_P11 il_S1_summaryeltcalc_P11 > /dev/null & pid2=$!
