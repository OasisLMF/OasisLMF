...
# --- Do ground up loss computes ---
tee < fifo/full_correlation/gul_S1_summary_P10 work/full_correlation/gul_S1_summaryaalcalc/P10.bin > /dev/null & pid3=$!
tee < fifo/full_correlation/gul_S1_summary_P10.idx work/full_correlation/gul_S1_summaryaalcalc/P10.idx > /dev/null & pid4=$!
