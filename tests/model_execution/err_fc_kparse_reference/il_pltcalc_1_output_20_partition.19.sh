...
( eve 20 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P20 -a1 -i - | fmcalc -a2 > fifo/il_P20  ) 2>> log/stderror.err &
...
# --- Do insured loss computes ---
pltcalc -s < il_S1_summarypltcalc_P20 > work/full_correlation/kat/il_S1_pltcalc_P20 & pid1=$!
tee < il_S1_summary_P20 il_S1_summarypltcalc_P20 > /dev/null & pid2=$!
