...
mkfifo gul_S1_summarysummarycalc_P17
mkfifo gul_S1_summarycalc_P17
...
mkfifo il_S1_summarysummarycalc_P17
mkfifo il_S1_summarycalc_P17
mkfifo il_S1_summarypltcalc_P17
mkfifo il_S1_pltcalc_P17
...
( eve 17 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P17 -a1 -i - | tee fifo/gul_P17 | fmcalc -a2 > fifo/il_P17  ) 2>> log/stderror.err &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8

# --- Do computes for fully correlated output ---

( fmcalc-a2 < gul_P17 > il_P17 ) 2>> log/stderror.err & fcpid1=$!
...
summarycalctocsv -s < il_S1_summarysummarycalc_P17 > work/full_correlation/kat/il_S1_summarycalc_P17 & pid2=$!
pltcalc -s < il_S1_summarypltcalc_P17 > work/full_correlation/kat/il_S1_pltcalc_P17 & pid3=$!
tee < il_S1_summary_P17 il_S1_summaryeltcalc_P17 il_S1_summarypltcalc_P17 il_S1_summarysummarycalc_P17 work/full_correlation/il_S1_summaryaalcalc/P17.bin work/full_correlation/il_S1_summaryleccalc/P17.bin > /dev/null & pid4=$!
( summarycalc -f  -1 il_S1_summary_P17 < il_P17 ) 2>> log/stderror.err  &

# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P17 > work/full_correlation/kat/gul_S1_eltcalc_P17 & pid5=$!
summarycalctocsv -s < gul_S1_summarysummarycalc_P17 > work/full_correlation/kat/gul_S1_summarycalc_P17 & pid6=$!
pltcalc -s < gul_S1_summarypltcalc_P17 > work/full_correlation/kat/gul_S1_pltcalc_P17 & pid7=$!
tee < gul_S1_summary_P17 gul_S1_summaryeltcalc_P17 gul_S1_summarypltcalc_P17 gul_S1_summarysummarycalc_P17 work/full_correlation/gul_S1_summaryaalcalc/P17.bin work/full_correlation/gul_S1_summaryleccalc/P17.bin > /dev/null & pid8=$!
( summarycalc -i  -1 gul_S1_summary_P17 < gul_P17 ) 2>> log/stderror.err  &
