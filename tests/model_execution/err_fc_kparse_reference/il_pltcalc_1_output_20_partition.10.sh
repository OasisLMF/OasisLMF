...
pltcalc -s < fifo/il_S1_summarypltcalc_P11 > work/kat/il_S1_pltcalc_P11 & pid1=$!
tee < fifo/il_S1_summary_P11 fifo/il_S1_summarypltcalc_P11 > /dev/null & pid2=$!
...
# --- Do insured loss computes ---
pltcalc -s < il_S1_summarypltcalc_P11 > work/full_correlation/kat/il_S1_pltcalc_P11 & pid1=$!
tee < il_S1_summary_P11 il_S1_summarypltcalc_P11 > /dev/null & pid2=$!
