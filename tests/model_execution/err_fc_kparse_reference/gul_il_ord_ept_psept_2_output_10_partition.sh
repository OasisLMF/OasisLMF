...
( eltcalc < fifo/full_correlation/il_S2_eltcalc_P1 > work/full_correlation/kat/il_S2_eltcalc_P1 ) 2>> $LOG_DIR/stderror.err & pid204=$!
( summarycalctocsv < fifo/full_correlation/il_S2_summarycalc_P1 > work/full_correlation/kat/il_S2_summarycalc_P1 ) 2>> $LOG_DIR/stderror.err & pid205=$!
( pltcalc < fifo/full_correlation/il_S2_pltcalc_P1 > work/full_correlation/kat/il_S2_pltcalc_P1 ) 2>> $LOG_DIR/stderror.err & pid206=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P2 > work/full_correlation/kat/il_S1_eltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid207=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P2 > work/full_correlation/kat/il_S1_summarycalc_P2 ) 2>> $LOG_DIR/stderror.err & pid208=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P2 > work/full_correlation/kat/il_S1_pltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid209=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P2 > work/full_correlation/kat/il_S2_eltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid210=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P2 > work/full_correlation/kat/il_S2_summarycalc_P2 ) 2>> $LOG_DIR/stderror.err & pid211=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P2 > work/full_correlation/kat/il_S2_pltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid212=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P3 > work/full_correlation/kat/il_S1_eltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid213=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P3 > work/full_correlation/kat/il_S1_summarycalc_P3 ) 2>> $LOG_DIR/stderror.err & pid214=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P3 > work/full_correlation/kat/il_S1_pltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid215=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P3 > work/full_correlation/kat/il_S2_eltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid216=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P3 > work/full_correlation/kat/il_S2_summarycalc_P3 ) 2>> $LOG_DIR/stderror.err & pid217=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P3 > work/full_correlation/kat/il_S2_pltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid218=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P4 > work/full_correlation/kat/il_S1_eltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid219=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P4 > work/full_correlation/kat/il_S1_summarycalc_P4 ) 2>> $LOG_DIR/stderror.err & pid220=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P4 > work/full_correlation/kat/il_S1_pltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid221=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P4 > work/full_correlation/kat/il_S2_eltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid222=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P4 > work/full_correlation/kat/il_S2_summarycalc_P4 ) 2>> $LOG_DIR/stderror.err & pid223=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P4 > work/full_correlation/kat/il_S2_pltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid224=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P5 > work/full_correlation/kat/il_S1_eltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid225=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P5 > work/full_correlation/kat/il_S1_summarycalc_P5 ) 2>> $LOG_DIR/stderror.err & pid226=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P5 > work/full_correlation/kat/il_S1_pltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid227=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P5 > work/full_correlation/kat/il_S2_eltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid228=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P5 > work/full_correlation/kat/il_S2_summarycalc_P5 ) 2>> $LOG_DIR/stderror.err & pid229=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P5 > work/full_correlation/kat/il_S2_pltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid230=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P6 > work/full_correlation/kat/il_S1_eltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid231=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P6 > work/full_correlation/kat/il_S1_summarycalc_P6 ) 2>> $LOG_DIR/stderror.err & pid232=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P6 > work/full_correlation/kat/il_S1_pltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid233=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P6 > work/full_correlation/kat/il_S2_eltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid234=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P6 > work/full_correlation/kat/il_S2_summarycalc_P6 ) 2>> $LOG_DIR/stderror.err & pid235=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P6 > work/full_correlation/kat/il_S2_pltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid236=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P7 > work/full_correlation/kat/il_S1_eltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid237=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P7 > work/full_correlation/kat/il_S1_summarycalc_P7 ) 2>> $LOG_DIR/stderror.err & pid238=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P7 > work/full_correlation/kat/il_S1_pltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid239=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P7 > work/full_correlation/kat/il_S2_eltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid240=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P7 > work/full_correlation/kat/il_S2_summarycalc_P7 ) 2>> $LOG_DIR/stderror.err & pid241=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P7 > work/full_correlation/kat/il_S2_pltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid242=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P8 > work/full_correlation/kat/il_S1_eltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid243=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P8 > work/full_correlation/kat/il_S1_summarycalc_P8 ) 2>> $LOG_DIR/stderror.err & pid244=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P8 > work/full_correlation/kat/il_S1_pltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid245=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P8 > work/full_correlation/kat/il_S2_eltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid246=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P8 > work/full_correlation/kat/il_S2_summarycalc_P8 ) 2>> $LOG_DIR/stderror.err & pid247=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P8 > work/full_correlation/kat/il_S2_pltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid248=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P9 > work/full_correlation/kat/il_S1_eltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid249=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P9 > work/full_correlation/kat/il_S1_summarycalc_P9 ) 2>> $LOG_DIR/stderror.err & pid250=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P9 > work/full_correlation/kat/il_S1_pltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid251=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P9 > work/full_correlation/kat/il_S2_eltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid252=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P9 > work/full_correlation/kat/il_S2_summarycalc_P9 ) 2>> $LOG_DIR/stderror.err & pid253=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P9 > work/full_correlation/kat/il_S2_pltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid254=$!
( eltcalc -s < fifo/full_correlation/il_S1_eltcalc_P10 > work/full_correlation/kat/il_S1_eltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid255=$!
( summarycalctocsv -s < fifo/full_correlation/il_S1_summarycalc_P10 > work/full_correlation/kat/il_S1_summarycalc_P10 ) 2>> $LOG_DIR/stderror.err & pid256=$!
( pltcalc -H < fifo/full_correlation/il_S1_pltcalc_P10 > work/full_correlation/kat/il_S1_pltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid257=$!
( eltcalc -s < fifo/full_correlation/il_S2_eltcalc_P10 > work/full_correlation/kat/il_S2_eltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid258=$!
( summarycalctocsv -s < fifo/full_correlation/il_S2_summarycalc_P10 > work/full_correlation/kat/il_S2_summarycalc_P10 ) 2>> $LOG_DIR/stderror.err & pid259=$!
( pltcalc -H < fifo/full_correlation/il_S2_pltcalc_P10 > work/full_correlation/kat/il_S2_pltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid260=$!
...
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P2 -2 fifo/full_correlation/il_S2_summary_P2 < fifo/full_correlation/il_P2 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P3 -2 fifo/full_correlation/il_S2_summary_P3 < fifo/full_correlation/il_P3 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P4 -2 fifo/full_correlation/il_S2_summary_P4 < fifo/full_correlation/il_P4 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P5 -2 fifo/full_correlation/il_S2_summary_P5 < fifo/full_correlation/il_P5 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P6 -2 fifo/full_correlation/il_S2_summary_P6 < fifo/full_correlation/il_P6 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P7 -2 fifo/full_correlation/il_S2_summary_P7 < fifo/full_correlation/il_P7 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P8 -2 fifo/full_correlation/il_S2_summary_P8 < fifo/full_correlation/il_P8 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P9 -2 fifo/full_correlation/il_S2_summary_P9 < fifo/full_correlation/il_P9 ) 2>> $LOG_DIR/stderror.err  &
( summarycalc -m -f  -1 fifo/full_correlation/il_S1_summary_P10 -2 fifo/full_correlation/il_S2_summary_P10 < fifo/full_correlation/il_P10 ) 2>> $LOG_DIR/stderror.err  &
...
( eltcalc < fifo/full_correlation/gul_S2_eltcalc_P1 > work/full_correlation/kat/gul_S2_eltcalc_P1 ) 2>> $LOG_DIR/stderror.err & pid304=$!
( summarycalctocsv < fifo/full_correlation/gul_S2_summarycalc_P1 > work/full_correlation/kat/gul_S2_summarycalc_P1 ) 2>> $LOG_DIR/stderror.err & pid305=$!
( pltcalc < fifo/full_correlation/gul_S2_pltcalc_P1 > work/full_correlation/kat/gul_S2_pltcalc_P1 ) 2>> $LOG_DIR/stderror.err & pid306=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P2 > work/full_correlation/kat/gul_S1_eltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid307=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P2 > work/full_correlation/kat/gul_S1_summarycalc_P2 ) 2>> $LOG_DIR/stderror.err & pid308=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P2 > work/full_correlation/kat/gul_S1_pltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid309=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P2 > work/full_correlation/kat/gul_S2_eltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid310=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P2 > work/full_correlation/kat/gul_S2_summarycalc_P2 ) 2>> $LOG_DIR/stderror.err & pid311=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P2 > work/full_correlation/kat/gul_S2_pltcalc_P2 ) 2>> $LOG_DIR/stderror.err & pid312=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P3 > work/full_correlation/kat/gul_S1_eltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid313=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P3 > work/full_correlation/kat/gul_S1_summarycalc_P3 ) 2>> $LOG_DIR/stderror.err & pid314=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P3 > work/full_correlation/kat/gul_S1_pltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid315=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P3 > work/full_correlation/kat/gul_S2_eltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid316=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P3 > work/full_correlation/kat/gul_S2_summarycalc_P3 ) 2>> $LOG_DIR/stderror.err & pid317=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P3 > work/full_correlation/kat/gul_S2_pltcalc_P3 ) 2>> $LOG_DIR/stderror.err & pid318=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P4 > work/full_correlation/kat/gul_S1_eltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid319=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P4 > work/full_correlation/kat/gul_S1_summarycalc_P4 ) 2>> $LOG_DIR/stderror.err & pid320=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P4 > work/full_correlation/kat/gul_S1_pltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid321=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P4 > work/full_correlation/kat/gul_S2_eltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid322=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P4 > work/full_correlation/kat/gul_S2_summarycalc_P4 ) 2>> $LOG_DIR/stderror.err & pid323=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P4 > work/full_correlation/kat/gul_S2_pltcalc_P4 ) 2>> $LOG_DIR/stderror.err & pid324=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P5 > work/full_correlation/kat/gul_S1_eltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid325=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P5 > work/full_correlation/kat/gul_S1_summarycalc_P5 ) 2>> $LOG_DIR/stderror.err & pid326=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P5 > work/full_correlation/kat/gul_S1_pltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid327=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P5 > work/full_correlation/kat/gul_S2_eltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid328=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P5 > work/full_correlation/kat/gul_S2_summarycalc_P5 ) 2>> $LOG_DIR/stderror.err & pid329=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P5 > work/full_correlation/kat/gul_S2_pltcalc_P5 ) 2>> $LOG_DIR/stderror.err & pid330=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P6 > work/full_correlation/kat/gul_S1_eltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid331=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P6 > work/full_correlation/kat/gul_S1_summarycalc_P6 ) 2>> $LOG_DIR/stderror.err & pid332=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P6 > work/full_correlation/kat/gul_S1_pltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid333=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P6 > work/full_correlation/kat/gul_S2_eltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid334=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P6 > work/full_correlation/kat/gul_S2_summarycalc_P6 ) 2>> $LOG_DIR/stderror.err & pid335=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P6 > work/full_correlation/kat/gul_S2_pltcalc_P6 ) 2>> $LOG_DIR/stderror.err & pid336=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P7 > work/full_correlation/kat/gul_S1_eltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid337=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P7 > work/full_correlation/kat/gul_S1_summarycalc_P7 ) 2>> $LOG_DIR/stderror.err & pid338=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P7 > work/full_correlation/kat/gul_S1_pltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid339=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P7 > work/full_correlation/kat/gul_S2_eltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid340=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P7 > work/full_correlation/kat/gul_S2_summarycalc_P7 ) 2>> $LOG_DIR/stderror.err & pid341=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P7 > work/full_correlation/kat/gul_S2_pltcalc_P7 ) 2>> $LOG_DIR/stderror.err & pid342=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P8 > work/full_correlation/kat/gul_S1_eltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid343=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P8 > work/full_correlation/kat/gul_S1_summarycalc_P8 ) 2>> $LOG_DIR/stderror.err & pid344=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P8 > work/full_correlation/kat/gul_S1_pltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid345=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P8 > work/full_correlation/kat/gul_S2_eltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid346=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P8 > work/full_correlation/kat/gul_S2_summarycalc_P8 ) 2>> $LOG_DIR/stderror.err & pid347=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P8 > work/full_correlation/kat/gul_S2_pltcalc_P8 ) 2>> $LOG_DIR/stderror.err & pid348=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P9 > work/full_correlation/kat/gul_S1_eltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid349=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P9 > work/full_correlation/kat/gul_S1_summarycalc_P9 ) 2>> $LOG_DIR/stderror.err & pid350=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P9 > work/full_correlation/kat/gul_S1_pltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid351=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P9 > work/full_correlation/kat/gul_S2_eltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid352=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P9 > work/full_correlation/kat/gul_S2_summarycalc_P9 ) 2>> $LOG_DIR/stderror.err & pid353=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P9 > work/full_correlation/kat/gul_S2_pltcalc_P9 ) 2>> $LOG_DIR/stderror.err & pid354=$!
( eltcalc -s < fifo/full_correlation/gul_S1_eltcalc_P10 > work/full_correlation/kat/gul_S1_eltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid355=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S1_summarycalc_P10 > work/full_correlation/kat/gul_S1_summarycalc_P10 ) 2>> $LOG_DIR/stderror.err & pid356=$!
( pltcalc -H < fifo/full_correlation/gul_S1_pltcalc_P10 > work/full_correlation/kat/gul_S1_pltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid357=$!
( eltcalc -s < fifo/full_correlation/gul_S2_eltcalc_P10 > work/full_correlation/kat/gul_S2_eltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid358=$!
( summarycalctocsv -s < fifo/full_correlation/gul_S2_summarycalc_P10 > work/full_correlation/kat/gul_S2_summarycalc_P10 ) 2>> $LOG_DIR/stderror.err & pid359=$!
( pltcalc -H < fifo/full_correlation/gul_S2_pltcalc_P10 > work/full_correlation/kat/gul_S2_pltcalc_P10 ) 2>> $LOG_DIR/stderror.err & pid360=$!
...
( ordleccalc -r -Kil_S1_summaryleccalc -F -S -s -M -m -W -w -O output/il_S1_ept.csv -o output/il_S1_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid2=$!
( aalcalc -Kil_S2_summaryaalcalc > output/il_S2_aalcalc.csv ) 2>> $LOG_DIR/stderror.err & lpid3=$!
( ordleccalc -r -Kil_S2_summaryleccalc -F -S -s -M -m -W -w -O output/il_S2_ept.csv -o output/il_S2_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid4=$!
( aalcalc -Kgul_S1_summaryaalcalc > output/gul_S1_aalcalc.csv ) 2>> $LOG_DIR/stderror.err & lpid5=$!
( ordleccalc -r -Kgul_S1_summaryleccalc -F -S -s -M -m -W -w -O output/gul_S1_ept.csv -o output/gul_S1_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid6=$!
( aalcalc -Kgul_S2_summaryaalcalc > output/gul_S2_aalcalc.csv ) 2>> $LOG_DIR/stderror.err & lpid7=$!
( ordleccalc -r -Kgul_S2_summaryleccalc -F -S -s -M -m -W -w -O output/gul_S2_ept.csv -o output/gul_S2_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid8=$!
( aalcalc -Kfull_correlation/il_S1_summaryaalcalc > output/full_correlation/il_S1_aalcalc.csv ) 2>> $LOG_DIR/stderror.err & lpid9=$!
( ordleccalc -r -Kfull_correlation/il_S1_summaryleccalc -F -S -s -M -m -W -w -O output/full_correlation/il_S1_ept.csv -o output/full_correlation/il_S1_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid10=$!
( aalcalc -Kfull_correlation/il_S2_summaryaalcalc > output/full_correlation/il_S2_aalcalc.csv ) 2>> $LOG_DIR/stderror.err & lpid11=$!
( ordleccalc -r -Kfull_correlation/il_S2_summaryleccalc -F -S -s -M -m -W -w -O output/full_correlation/il_S2_ept.csv -o output/full_correlation/il_S2_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid12=$!
( aalcalc -Kfull_correlation/gul_S1_summaryaalcalc > output/full_correlation/gul_S1_aalcalc.csv ) 2>> $LOG_DIR/stderror.err & lpid13=$!
( ordleccalc -r -Kfull_correlation/gul_S1_summaryleccalc -F -S -s -M -m -W -w -O output/full_correlation/gul_S1_ept.csv -o output/full_correlation/gul_S1_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid14=$!
( aalcalc -Kfull_correlation/gul_S2_summaryaalcalc > output/full_correlation/gul_S2_aalcalc.csv ) 2>> $LOG_DIR/stderror.err & lpid15=$!
( ordleccalc -r -Kfull_correlation/gul_S2_summaryleccalc -F -S -s -M -m -W -w -O output/full_correlation/gul_S2_ept.csv -o output/full_correlation/gul_S2_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid16=$!
