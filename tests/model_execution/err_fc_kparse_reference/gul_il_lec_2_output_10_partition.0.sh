...
tee < fifo/il_S2_summary_P1 > /dev/null & pid2=$!

( summarypy -m -t il  -1 fifo/il_S1_summary_P1 -2 fifo/il_S2_summary_P1 < fifo/il_P1 ) 2>> $LOG_DIR/stderror.err  &
...
tee < fifo/gul_S2_summary_P1 > /dev/null & pid4=$!

( summarypy -m -t gul  -1 fifo/gul_S1_summary_P1 -2 fifo/gul_S2_summary_P1 < fifo/gul_P1 ) 2>> $LOG_DIR/stderror.err  &

( ( evepy 1 10 | gulmc --socket-server='False' --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee fifo/gul_P1 | fmpy -a2 > fifo/il_P1  ) 2>> $LOG_DIR/stderror.err ) & pid5=$!
