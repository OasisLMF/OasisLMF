...
( aalcalc -Kil_S2_summary_palt -o > output/il_S2_palt.csv ) 2>> log/stderror.err & lpid4=$!
( ordleccalc -r -Kil_S2_summaryleccalc -F -S -s -M -m -W -w -O output/il_S2_ept.csv -o output/il_S2_psept.csv ) 2>> log/stderror.err & lpid5=$!
( aalcalc -Kgul_S1_summaryaalcalc > output/gul_S1_aalcalc.csv ) 2>> log/stderror.err & lpid6=$!
( aalcalc -Kgul_S1_summary_palt -o > output/gul_S1_palt.csv ) 2>> log/stderror.err & lpid7=$!
( ordleccalc -r -Kgul_S1_summaryleccalc -F -S -s -M -m -W -w -O output/gul_S1_ept.csv -o output/gul_S1_psept.csv ) 2>> log/stderror.err & lpid8=$!
( aalcalc -Kgul_S2_summaryaalcalc > output/gul_S2_aalcalc.csv ) 2>> log/stderror.err & lpid9=$!
( aalcalc -Kgul_S2_summary_palt -o > output/gul_S2_palt.csv ) 2>> log/stderror.err & lpid10=$!
( ordleccalc -r -Kgul_S2_summaryleccalc -F -S -s -M -m -W -w -O output/gul_S2_ept.csv -o output/gul_S2_psept.csv ) 2>> log/stderror.err & lpid11=$!
