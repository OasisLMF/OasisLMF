...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P29 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P29  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P29  ) & pid21=$!
( evepy 29 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P29 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P29 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P29  ) & pid22=$!
