...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P40 > work/kat/il_S1_eltcalc_P40 & pid1=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P40 > work/kat/il_S1_summarycalc_P40 & pid2=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P40 > work/kat/il_S1_pltcalc_P40 & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P40 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P40 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P40 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P40 work/il_S1_summaryaalcalc/P40.bin work/il_S1_summaryleccalc/P40.bin > /dev/null & pid4=$!
summarycalc -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P40 < /tmp/%FIFO_DIR%/fifo/il_P40 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P40 > work/kat/gul_S1_eltcalc_P40 & pid5=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P40 > work/kat/gul_S1_summarycalc_P40 & pid6=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P40 > work/kat/gul_S1_pltcalc_P40 & pid7=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P40 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P40 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P40 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P40 work/gul_S1_summaryaalcalc/P40.bin work/gul_S1_summaryleccalc/P40.bin > /dev/null & pid8=$!
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P40 < /tmp/%FIFO_DIR%/fifo/gul_P40 &

eve 40 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P40 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P40 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P40  &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8

# --- Do computes for fully correlated output ---

fmcalc-a2 < gul_P40 > il_P40 & fcpid1=$!
...
summarycalc -f  -1 il_S1_summary_P40 < il_P40 &
...
summarycalc -i  -1 gul_S1_summary_P40 < gul_P40 &
