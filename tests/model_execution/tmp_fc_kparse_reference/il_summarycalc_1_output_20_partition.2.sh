...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P3 > work/kat/il_S1_summarycalc_P3 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P3 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P3 > /dev/null & pid2=$!
