...
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P16 > work/kat/il_S1_pltcalc_P16 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P16 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P16 > /dev/null & pid2=$!
summarycalc -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P16 < /tmp/%FIFO_DIR%/fifo/il_P16 &

eve 16 20 | getmodel | gulcalc -S100 -L100 -r -j gul_P16 -a1 -i - | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P16  &
...
# --- Do insured loss computes ---
pltcalc -s < il_S1_summarypltcalc_P16 > work/full_correlation/kat/il_S1_pltcalc_P16 & pid1=$!
tee < il_S1_summary_P16 il_S1_summarypltcalc_P16 > /dev/null & pid2=$!
