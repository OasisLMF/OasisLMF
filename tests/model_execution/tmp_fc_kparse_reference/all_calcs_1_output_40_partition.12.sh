...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P13 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P13  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P13  ) & pid21=$!
( evepy 13 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P13 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P13 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P13  ) & pid22=$!
