...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P4 > work/kat/gul_S1_eltcalc_P4 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P4 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P4 > /dev/null & pid2=$!
...
# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P4 > work/full_correlation/kat/gul_S1_eltcalc_P4 & pid1=$!
tee < gul_S1_summary_P4 gul_S1_summaryeltcalc_P4 > /dev/null & pid2=$!
