...
eve 33 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P33 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P33 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P33  &

wait $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8

# --- Do computes for fully correlated output ---

fmcalc-a2 < gul_P33 > il_P33 & fcpid1=$!
...
summarycalc -f  -1 il_S1_summary_P33 < il_P33 &
...
summarycalc -i  -1 gul_S1_summary_P33 < gul_P33 &
