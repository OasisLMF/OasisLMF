...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P17 > work/kat/gul_S1_summarycalc_P17 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P17 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P17 > /dev/null & pid2=$!
...
# --- Do ground up loss computes ---
summarycalctocsv -s < gul_S1_summarysummarycalc_P17 > work/full_correlation/kat/gul_S1_summarycalc_P17 & pid1=$!
tee < gul_S1_summary_P17 gul_S1_summarysummarycalc_P17 > /dev/null & pid2=$!
