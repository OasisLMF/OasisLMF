...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P16 > work/kat/il_S1_summarycalc_P16 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P16 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P16 > /dev/null & pid2=$!
