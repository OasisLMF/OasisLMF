...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P15 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P15  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P15  ) & pid21=$!
( evepy 15 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P15 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P15 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P15  ) & pid22=$!
