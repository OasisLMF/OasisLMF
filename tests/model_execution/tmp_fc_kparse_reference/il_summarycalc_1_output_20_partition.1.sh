...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P2 > work/kat/il_S1_summarycalc_P2 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P2 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P2 > /dev/null & pid2=$!
...
# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P2 > work/full_correlation/kat/il_S1_summarycalc_P2 & pid1=$!
tee < il_S1_summary_P2 il_S1_summarysummarycalc_P2 > /dev/null & pid2=$!
