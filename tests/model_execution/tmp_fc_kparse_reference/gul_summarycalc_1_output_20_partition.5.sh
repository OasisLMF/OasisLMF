...
# --- Do ground up loss computes ---
summarycalctocsv -s < gul_S1_summarysummarycalc_P6 > work/full_correlation/kat/gul_S1_summarycalc_P6 & pid1=$!
tee < gul_S1_summary_P6 gul_S1_summarysummarycalc_P6 > /dev/null & pid2=$!
