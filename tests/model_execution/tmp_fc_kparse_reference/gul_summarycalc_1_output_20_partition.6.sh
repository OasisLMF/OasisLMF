...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P7 > work/kat/gul_S1_summarycalc_P7 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P7 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P7 > /dev/null & pid2=$!
...
# --- Do ground up loss computes ---
summarycalctocsv -s < gul_S1_summarysummarycalc_P7 > work/full_correlation/kat/gul_S1_summarycalc_P7 & pid1=$!
tee < gul_S1_summary_P7 gul_S1_summarysummarycalc_P7 > /dev/null & pid2=$!
...
kat work/full_correlation/kat/gul_S1_summarycalc_P7 > output/full_correlation/gul_S1_summarycalc.csv & kpid2=$!
wait $kpid1 $kpid2
