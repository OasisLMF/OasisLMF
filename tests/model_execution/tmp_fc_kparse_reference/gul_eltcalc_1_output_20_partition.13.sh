...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P14 > work/kat/gul_S1_eltcalc_P14 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P14 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P14 > /dev/null & pid2=$!
...
# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P14 > work/full_correlation/kat/gul_S1_eltcalc_P14 & pid1=$!
tee < gul_S1_summary_P14 gul_S1_summaryeltcalc_P14 > /dev/null & pid2=$!
