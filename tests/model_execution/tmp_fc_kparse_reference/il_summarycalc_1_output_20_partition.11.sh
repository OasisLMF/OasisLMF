...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P12 > work/kat/il_S1_summarycalc_P12 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P12 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P12 > /dev/null & pid2=$!
