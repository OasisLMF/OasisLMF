...
eve 5 10 | getmodel | gulcalc -S0 -L0 -r -j gul_P5 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P5 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P5  &
...
summarycalc -f  -1 il_S1_summary_P5 -2 il_S2_summary_P5 < il_P5 &
...
summarycalc -i  -1 gul_S1_summary_P5 -2 gul_S2_summary_P5 < gul_P5 &
