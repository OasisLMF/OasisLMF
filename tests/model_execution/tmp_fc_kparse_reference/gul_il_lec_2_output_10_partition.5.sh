...
mkfifo gul_S2_summary_P6
mkfifo gul_S2_summaryeltcalc_P6
mkfifo gul_S2_eltcalc_P6
mkfifo gul_S2_summarysummarycalc_P6
mkfifo gul_S2_summarycalc_P6
mkfifo gul_S2_summarypltcalc_P6
mkfifo gul_S2_pltcalc_P6
...
mkfifo il_S2_summary_P6
mkfifo il_S2_summaryeltcalc_P6
mkfifo il_S2_eltcalc_P6
mkfifo il_S2_summarysummarycalc_P6
mkfifo il_S2_summarycalc_P6
mkfifo il_S2_summarypltcalc_P6
mkfifo il_S2_pltcalc_P6
...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P6 > work/kat/il_S2_eltcalc_P6 & pid4=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P6 > work/kat/il_S2_summarycalc_P6 & pid5=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P6 > work/kat/il_S2_pltcalc_P6 & pid6=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P6 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P6 work/il_S1_summaryaalcalc/P6.bin work/il_S1_summaryleccalc/P6.bin > /dev/null & pid7=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P6 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P6 work/il_S2_summaryaalcalc/P6.bin work/il_S2_summaryleccalc/P6.bin > /dev/null & pid8=$!
summarycalc -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P6 -2 /tmp/%FIFO_DIR%/fifo/il_S2_summary_P6 < /tmp/%FIFO_DIR%/fifo/il_P6 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P6 > work/kat/gul_S1_eltcalc_P6 & pid9=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P6 > work/kat/gul_S1_summarycalc_P6 & pid10=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P6 > work/kat/gul_S1_pltcalc_P6 & pid11=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P6 > work/kat/gul_S2_eltcalc_P6 & pid12=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P6 > work/kat/gul_S2_summarycalc_P6 & pid13=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P6 > work/kat/gul_S2_pltcalc_P6 & pid14=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P6 work/gul_S1_summaryaalcalc/P6.bin work/gul_S1_summaryleccalc/P6.bin > /dev/null & pid15=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P6 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P6 work/gul_S2_summaryaalcalc/P6.bin work/gul_S2_summaryleccalc/P6.bin > /dev/null & pid16=$!
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6 -2 /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P6 < /tmp/%FIFO_DIR%/fifo/gul_P6 &

eve 6 10 | getmodel | gulcalc -S0 -L0 -r -j gul_P6 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P6 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P6  &
...
eltcalc -s < il_S2_summaryeltcalc_P6 > work/full_correlation/kat/il_S2_eltcalc_P6 & pid4=$!
summarycalctocsv -s < il_S2_summarysummarycalc_P6 > work/full_correlation/kat/il_S2_summarycalc_P6 & pid5=$!
pltcalc -s < il_S2_summarypltcalc_P6 > work/full_correlation/kat/il_S2_pltcalc_P6 & pid6=$!
tee < il_S1_summary_P6 il_S1_summaryeltcalc_P6 il_S1_summarypltcalc_P6 il_S1_summarysummarycalc_P6 work/full_correlation/il_S1_summaryaalcalc/P6.bin work/full_correlation/il_S1_summaryleccalc/P6.bin > /dev/null & pid7=$!
tee < il_S2_summary_P6 il_S2_summaryeltcalc_P6 il_S2_summarypltcalc_P6 il_S2_summarysummarycalc_P6 work/full_correlation/il_S2_summaryaalcalc/P6.bin work/full_correlation/il_S2_summaryleccalc/P6.bin > /dev/null & pid8=$!
summarycalc -f  -1 il_S1_summary_P6 -2 il_S2_summary_P6 < il_P6 &

# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P6 > work/full_correlation/kat/gul_S1_eltcalc_P6 & pid9=$!
summarycalctocsv -s < gul_S1_summarysummarycalc_P6 > work/full_correlation/kat/gul_S1_summarycalc_P6 & pid10=$!
pltcalc -s < gul_S1_summarypltcalc_P6 > work/full_correlation/kat/gul_S1_pltcalc_P6 & pid11=$!
eltcalc -s < gul_S2_summaryeltcalc_P6 > work/full_correlation/kat/gul_S2_eltcalc_P6 & pid12=$!
summarycalctocsv -s < gul_S2_summarysummarycalc_P6 > work/full_correlation/kat/gul_S2_summarycalc_P6 & pid13=$!
pltcalc -s < gul_S2_summarypltcalc_P6 > work/full_correlation/kat/gul_S2_pltcalc_P6 & pid14=$!
tee < gul_S1_summary_P6 gul_S1_summaryeltcalc_P6 gul_S1_summarypltcalc_P6 gul_S1_summarysummarycalc_P6 work/full_correlation/gul_S1_summaryaalcalc/P6.bin work/full_correlation/gul_S1_summaryleccalc/P6.bin > /dev/null & pid15=$!
tee < gul_S2_summary_P6 gul_S2_summaryeltcalc_P6 gul_S2_summarypltcalc_P6 gul_S2_summarysummarycalc_P6 work/full_correlation/gul_S2_summaryaalcalc/P6.bin work/full_correlation/gul_S2_summaryleccalc/P6.bin > /dev/null & pid16=$!
summarycalc -i  -1 gul_S1_summary_P6 -2 gul_S2_summary_P6 < gul_P6 &
