...
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P2 > work/kat/gul_S1_pltcalc_P2 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P2 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P2 > /dev/null & pid2=$!
...
# --- Do ground up loss computes ---
pltcalc -s < gul_S1_summarypltcalc_P2 > work/full_correlation/kat/gul_S1_pltcalc_P2 & pid1=$!
tee < gul_S1_summary_P2 gul_S1_summarypltcalc_P2 > /dev/null & pid2=$!
