...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_eltcalc_P37 > work/kat/il_S1_eltcalc_P37 & pid1=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarycalc_P37 > work/kat/il_S1_summarycalc_P37 & pid2=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_pltcalc_P37 > work/kat/il_S1_pltcalc_P37 & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P37 /tmp/%FIFO_DIR%/fifo/il_S1_eltcalc_P37 /tmp/%FIFO_DIR%/fifo/il_S1_summarycalc_P37 /tmp/%FIFO_DIR%/fifo/il_S1_pltcalc_P37 work/il_S1_summaryaalcalc/P37.bin work/il_S1_summaryleccalc/P37.bin > /dev/null & pid4=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P37.idx work/il_S1_summaryleccalc/P37.idx > /dev/null & pid5=$!
summarycalc -m -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P37 < /tmp/%FIFO_DIR%/fifo/il_P37 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_eltcalc_P37 > work/kat/gul_S1_eltcalc_P37 & pid6=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarycalc_P37 > work/kat/gul_S1_summarycalc_P37 & pid7=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_pltcalc_P37 > work/kat/gul_S1_pltcalc_P37 & pid8=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P37 /tmp/%FIFO_DIR%/fifo/gul_S1_eltcalc_P37 /tmp/%FIFO_DIR%/fifo/gul_S1_summarycalc_P37 /tmp/%FIFO_DIR%/fifo/gul_S1_pltcalc_P37 work/gul_S1_summaryaalcalc/P37.bin work/gul_S1_summaryleccalc/P37.bin > /dev/null & pid9=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P37.idx work/gul_S1_summaryleccalc/P37.idx > /dev/null & pid10=$!
summarycalc -m -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P37 < /tmp/%FIFO_DIR%/fifo/gul_P37 &

# --- Do insured loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P37 > work/full_correlation/kat/il_S1_eltcalc_P37 & pid11=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P37 > work/full_correlation/kat/il_S1_summarycalc_P37 & pid12=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P37 > work/full_correlation/kat/il_S1_pltcalc_P37 & pid13=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P37 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P37 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P37 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P37 work/full_correlation/il_S1_summaryaalcalc/P37.bin work/full_correlation/il_S1_summaryleccalc/P37.bin > /dev/null & pid14=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P37.idx work/full_correlation/il_S1_summaryleccalc/P37.idx > /dev/null & pid15=$!
summarycalc -m -f  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P37 < /tmp/%FIFO_DIR%/fifo/full_correlation/il_P37 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P37 > work/full_correlation/kat/gul_S1_eltcalc_P37 & pid16=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P37 > work/full_correlation/kat/gul_S1_summarycalc_P37 & pid17=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P37 > work/full_correlation/kat/gul_S1_pltcalc_P37 & pid18=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P37 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P37 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P37 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P37 work/full_correlation/gul_S1_summaryaalcalc/P37.bin work/full_correlation/gul_S1_summaryleccalc/P37.bin > /dev/null & pid19=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P37.idx work/full_correlation/gul_S1_summaryleccalc/P37.idx > /dev/null & pid20=$!
...
kat -s work/full_correlation/kat/il_S1_eltcalc_P37 > output/full_correlation/il_S1_eltcalc.csv & kpid4=$!
...
kat -s work/kat/gul_S1_eltcalc_P37 > output/gul_S1_eltcalc.csv & kpid7=$!
...
kat -s work/full_correlation/kat/gul_S1_eltcalc_P37 > output/full_correlation/gul_S1_eltcalc.csv & kpid10=$!
