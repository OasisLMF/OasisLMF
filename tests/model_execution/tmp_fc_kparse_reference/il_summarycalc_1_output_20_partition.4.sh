...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P5 > work/kat/il_S1_summarycalc_P5 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P5 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P5 > /dev/null & pid2=$!
...
# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P5 > work/full_correlation/kat/il_S1_summarycalc_P5 & pid1=$!
tee < il_S1_summary_P5 il_S1_summarysummarycalc_P5 > /dev/null & pid2=$!
