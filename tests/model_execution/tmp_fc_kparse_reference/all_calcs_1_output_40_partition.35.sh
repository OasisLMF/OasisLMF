...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P36 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P36  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P36  ) & pid21=$!
( evepy 36 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P36 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P36 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P36  ) & pid22=$!
