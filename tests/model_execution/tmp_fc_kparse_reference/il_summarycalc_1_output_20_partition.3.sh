...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P4 > work/kat/il_S1_summarycalc_P4 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P4 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P4 > /dev/null & pid2=$!
...
# --- Do insured loss computes ---
summarycalctocsv -s < il_S1_summarysummarycalc_P4 > work/full_correlation/kat/il_S1_summarycalc_P4 & pid1=$!
tee < il_S1_summary_P4 il_S1_summarysummarycalc_P4 > /dev/null & pid2=$!
