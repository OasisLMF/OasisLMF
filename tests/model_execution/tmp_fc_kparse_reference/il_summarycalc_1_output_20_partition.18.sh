...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P19 > work/kat/il_S1_summarycalc_P19 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P19 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P19 > /dev/null & pid2=$!
