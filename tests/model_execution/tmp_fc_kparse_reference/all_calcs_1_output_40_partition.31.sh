...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P32 > work/kat/il_S1_eltcalc_P32 & pid1=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P32 > work/kat/il_S1_summarycalc_P32 & pid2=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P32 > work/kat/il_S1_pltcalc_P32 & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P32 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P32 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P32 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P32 work/il_S1_summaryaalcalc/P32.bin work/il_S1_summaryleccalc/P32.bin > /dev/null & pid4=$!
summarycalc -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P32 < /tmp/%FIFO_DIR%/fifo/il_P32 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P32 > work/kat/gul_S1_eltcalc_P32 & pid5=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P32 > work/kat/gul_S1_summarycalc_P32 & pid6=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P32 > work/kat/gul_S1_pltcalc_P32 & pid7=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P32 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P32 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P32 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P32 work/gul_S1_summaryaalcalc/P32.bin work/gul_S1_summaryleccalc/P32.bin > /dev/null & pid8=$!
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P32 < /tmp/%FIFO_DIR%/fifo/gul_P32 &

eve 32 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P32 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P32 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P32  &
