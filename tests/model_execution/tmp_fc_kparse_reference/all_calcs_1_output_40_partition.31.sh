...
find /tmp/%FIFO_DIR%/fifo/ \( -name '*P32[^0-9]*' -o -name '*P32' \) -exec rm -R -f {} +
...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_eltcalc_P32 > work/kat/il_S1_eltcalc_P32 & pid1=$!
...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_eltcalc_P32 > work/kat/gul_S1_eltcalc_P32 & pid6=$!
...
# --- Do insured loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P32 > work/full_correlation/kat/il_S1_eltcalc_P32 & pid11=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P32 > work/full_correlation/kat/il_S1_summarycalc_P32 & pid12=$!
pltcalc -H < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P32 > work/full_correlation/kat/il_S1_pltcalc_P32 & pid13=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P32 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P32 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P32 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P32 work/full_correlation/il_S1_summaryaalcalc/P32.bin work/full_correlation/il_S1_summaryleccalc/P32.bin > /dev/null & pid14=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P32.idx work/full_correlation/il_S1_summaryaalcalc/P32.idx work/full_correlation/il_S1_summaryleccalc/P32.idx > /dev/null & pid15=$!
summarycalc -m -f  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P32 < /tmp/%FIFO_DIR%/fifo/full_correlation/il_P32 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P32 > work/full_correlation/kat/gul_S1_eltcalc_P32 & pid16=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P32 > work/full_correlation/kat/gul_S1_summarycalc_P32 & pid17=$!
pltcalc -H < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P32 > work/full_correlation/kat/gul_S1_pltcalc_P32 & pid18=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P32 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P32 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P32 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P32 work/full_correlation/gul_S1_summaryaalcalc/P32.bin work/full_correlation/gul_S1_summaryleccalc/P32.bin > /dev/null & pid19=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P32.idx work/full_correlation/gul_S1_summaryaalcalc/P32.idx work/full_correlation/gul_S1_summaryleccalc/P32.idx > /dev/null & pid20=$!
summarycalc -m -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P32 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P32 &

( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P32 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P32  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P32  ) & pid21=$!
( evepy 32 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P32 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P32 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P32  ) & pid22=$!
