...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P3.idx work/full_correlation/il_S1_summaryleccalc/P3.idx > /dev/null & pid28=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P3.idx work/full_correlation/il_S2_summaryleccalc/P3.idx > /dev/null & pid30=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P3.idx work/full_correlation/gul_S1_summaryleccalc/P3.idx > /dev/null & pid38=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P3.idx work/full_correlation/gul_S2_summaryleccalc/P3.idx > /dev/null & pid40=$!
