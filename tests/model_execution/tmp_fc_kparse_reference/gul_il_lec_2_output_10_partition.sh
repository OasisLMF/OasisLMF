...
eltcalc < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P1 > work/full_correlation/kat/gul_S2_eltcalc_P1 & pid164=$!
summarycalctocsv < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P1 > work/full_correlation/kat/gul_S2_summarycalc_P1 & pid165=$!
pltcalc < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P1 > work/full_correlation/kat/gul_S2_pltcalc_P1 & pid166=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P2 > work/full_correlation/kat/gul_S1_eltcalc_P2 & pid167=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P2 > work/full_correlation/kat/gul_S1_summarycalc_P2 & pid168=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P2 > work/full_correlation/kat/gul_S1_pltcalc_P2 & pid169=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P2 > work/full_correlation/kat/gul_S2_eltcalc_P2 & pid170=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P2 > work/full_correlation/kat/gul_S2_summarycalc_P2 & pid171=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P2 > work/full_correlation/kat/gul_S2_pltcalc_P2 & pid172=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P3 > work/full_correlation/kat/gul_S1_eltcalc_P3 & pid173=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P3 > work/full_correlation/kat/gul_S1_summarycalc_P3 & pid174=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P3 > work/full_correlation/kat/gul_S1_pltcalc_P3 & pid175=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P3 > work/full_correlation/kat/gul_S2_eltcalc_P3 & pid176=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P3 > work/full_correlation/kat/gul_S2_summarycalc_P3 & pid177=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P3 > work/full_correlation/kat/gul_S2_pltcalc_P3 & pid178=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P4 > work/full_correlation/kat/gul_S1_eltcalc_P4 & pid179=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P4 > work/full_correlation/kat/gul_S1_summarycalc_P4 & pid180=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P4 > work/full_correlation/kat/gul_S1_pltcalc_P4 & pid181=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P4 > work/full_correlation/kat/gul_S2_eltcalc_P4 & pid182=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P4 > work/full_correlation/kat/gul_S2_summarycalc_P4 & pid183=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P4 > work/full_correlation/kat/gul_S2_pltcalc_P4 & pid184=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P5 > work/full_correlation/kat/gul_S1_eltcalc_P5 & pid185=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P5 > work/full_correlation/kat/gul_S1_summarycalc_P5 & pid186=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P5 > work/full_correlation/kat/gul_S1_pltcalc_P5 & pid187=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P5 > work/full_correlation/kat/gul_S2_eltcalc_P5 & pid188=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P5 > work/full_correlation/kat/gul_S2_summarycalc_P5 & pid189=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P5 > work/full_correlation/kat/gul_S2_pltcalc_P5 & pid190=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P6 > work/full_correlation/kat/gul_S1_eltcalc_P6 & pid191=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P6 > work/full_correlation/kat/gul_S1_summarycalc_P6 & pid192=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P6 > work/full_correlation/kat/gul_S1_pltcalc_P6 & pid193=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P6 > work/full_correlation/kat/gul_S2_eltcalc_P6 & pid194=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P6 > work/full_correlation/kat/gul_S2_summarycalc_P6 & pid195=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P6 > work/full_correlation/kat/gul_S2_pltcalc_P6 & pid196=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P7 > work/full_correlation/kat/gul_S1_eltcalc_P7 & pid197=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P7 > work/full_correlation/kat/gul_S1_summarycalc_P7 & pid198=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P7 > work/full_correlation/kat/gul_S1_pltcalc_P7 & pid199=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P7 > work/full_correlation/kat/gul_S2_eltcalc_P7 & pid200=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P7 > work/full_correlation/kat/gul_S2_summarycalc_P7 & pid201=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P7 > work/full_correlation/kat/gul_S2_pltcalc_P7 & pid202=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P8 > work/full_correlation/kat/gul_S1_eltcalc_P8 & pid203=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P8 > work/full_correlation/kat/gul_S1_summarycalc_P8 & pid204=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P8 > work/full_correlation/kat/gul_S1_pltcalc_P8 & pid205=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P8 > work/full_correlation/kat/gul_S2_eltcalc_P8 & pid206=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P8 > work/full_correlation/kat/gul_S2_summarycalc_P8 & pid207=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P8 > work/full_correlation/kat/gul_S2_pltcalc_P8 & pid208=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P9 > work/full_correlation/kat/gul_S1_eltcalc_P9 & pid209=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P9 > work/full_correlation/kat/gul_S1_summarycalc_P9 & pid210=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P9 > work/full_correlation/kat/gul_S1_pltcalc_P9 & pid211=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P9 > work/full_correlation/kat/gul_S2_eltcalc_P9 & pid212=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P9 > work/full_correlation/kat/gul_S2_summarycalc_P9 & pid213=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P9 > work/full_correlation/kat/gul_S2_pltcalc_P9 & pid214=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P10 > work/full_correlation/kat/gul_S1_eltcalc_P10 & pid215=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P10 > work/full_correlation/kat/gul_S1_summarycalc_P10 & pid216=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P10 > work/full_correlation/kat/gul_S1_pltcalc_P10 & pid217=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P10 > work/full_correlation/kat/gul_S2_eltcalc_P10 & pid218=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P10 > work/full_correlation/kat/gul_S2_summarycalc_P10 & pid219=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P10 > work/full_correlation/kat/gul_S2_pltcalc_P10 & pid220=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P2 work/full_correlation/gul_S2_summaryaalcalc/P2.bin work/full_correlation/gul_S2_summaryleccalc/P2.bin > /dev/null & pid224=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P3 work/full_correlation/gul_S2_summaryaalcalc/P3.bin work/full_correlation/gul_S2_summaryleccalc/P3.bin > /dev/null & pid226=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P4 work/full_correlation/gul_S2_summaryaalcalc/P4.bin work/full_correlation/gul_S2_summaryleccalc/P4.bin > /dev/null & pid228=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P6 work/full_correlation/gul_S2_summaryaalcalc/P6.bin work/full_correlation/gul_S2_summaryleccalc/P6.bin > /dev/null & pid232=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P7 work/full_correlation/gul_S2_summaryaalcalc/P7.bin work/full_correlation/gul_S2_summaryleccalc/P7.bin > /dev/null & pid234=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P8 work/full_correlation/gul_S2_summaryaalcalc/P8.bin work/full_correlation/gul_S2_summaryleccalc/P8.bin > /dev/null & pid236=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P9 work/full_correlation/gul_S2_summaryaalcalc/P9.bin work/full_correlation/gul_S2_summaryleccalc/P9.bin > /dev/null & pid238=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P10 work/full_correlation/gul_S2_summaryaalcalc/P10.bin work/full_correlation/gul_S2_summaryleccalc/P10.bin > /dev/null & pid240=$!
...
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P1 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P1 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P1 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P2 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P2 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P2 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P3 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P3 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P3 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P4 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P4 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P4 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P5 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P5 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P5 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P6 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P6 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P6 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P7 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P7 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P7 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P8 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P8 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P8 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P9 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P9 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P9 &
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P10 -2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P10 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_sumcalc_P10 &
