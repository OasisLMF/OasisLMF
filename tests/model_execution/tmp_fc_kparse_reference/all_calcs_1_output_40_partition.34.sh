...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P35 > work/kat/il_S1_eltcalc_P35 & pid1=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P35 > work/kat/il_S1_summarycalc_P35 & pid2=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P35 > work/kat/il_S1_pltcalc_P35 & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P35 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P35 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P35 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P35 work/il_S1_summaryaalcalc/P35.bin work/il_S1_summaryleccalc/P35.bin > /dev/null & pid4=$!
summarycalc -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P35 < /tmp/%FIFO_DIR%/fifo/il_P35 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P35 > work/kat/gul_S1_eltcalc_P35 & pid5=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P35 > work/kat/gul_S1_summarycalc_P35 & pid6=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P35 > work/kat/gul_S1_pltcalc_P35 & pid7=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P35 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P35 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P35 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P35 work/gul_S1_summaryaalcalc/P35.bin work/gul_S1_summaryleccalc/P35.bin > /dev/null & pid8=$!
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P35 < /tmp/%FIFO_DIR%/fifo/gul_P35 &

eve 35 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P35 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P35 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P35  &
