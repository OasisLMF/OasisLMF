...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P5 > work/kat/gul_S1_eltcalc_P5 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P5 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P5 > /dev/null & pid2=$!
...
# --- Do ground up loss computes ---
eltcalc -s < gul_S1_summaryeltcalc_P5 > work/full_correlation/kat/gul_S1_eltcalc_P5 & pid1=$!
tee < gul_S1_summary_P5 gul_S1_summaryeltcalc_P5 > /dev/null & pid2=$!
