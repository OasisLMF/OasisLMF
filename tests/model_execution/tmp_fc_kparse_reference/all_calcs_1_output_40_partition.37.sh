...
# --- Do insured loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P38 > work/full_correlation/kat/il_S1_eltcalc_P38 & pid11=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P38 > work/full_correlation/kat/il_S1_summarycalc_P38 & pid12=$!
pltcalc -H < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P38 > work/full_correlation/kat/il_S1_pltcalc_P38 & pid13=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P38 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P38 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P38 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P38 work/full_correlation/il_S1_summaryaalcalc/P38.bin work/full_correlation/il_S1_summaryleccalc/P38.bin > /dev/null & pid14=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P38.idx work/full_correlation/il_S1_summaryaalcalc/P38.idx work/full_correlation/il_S1_summaryleccalc/P38.idx > /dev/null & pid15=$!
summarycalc -m -f  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P38 < /tmp/%FIFO_DIR%/fifo/full_correlation/il_P38 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P38 > work/full_correlation/kat/gul_S1_eltcalc_P38 & pid16=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P38 > work/full_correlation/kat/gul_S1_summarycalc_P38 & pid17=$!
pltcalc -H < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P38 > work/full_correlation/kat/gul_S1_pltcalc_P38 & pid18=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P38 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P38 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P38 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P38 work/full_correlation/gul_S1_summaryaalcalc/P38.bin work/full_correlation/gul_S1_summaryleccalc/P38.bin > /dev/null & pid19=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P38.idx work/full_correlation/gul_S1_summaryaalcalc/P38.idx work/full_correlation/gul_S1_summaryleccalc/P38.idx > /dev/null & pid20=$!
summarycalc -m -i  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P38 < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P38 &

( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P38 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P38  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P38  ) & pid21=$!
( evepy 38 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P38 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P38 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P38  ) & pid22=$!
