...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P19 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P19  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P19  ) & pid21=$!
( evepy 19 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P19 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P19 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P19  ) & pid22=$!
