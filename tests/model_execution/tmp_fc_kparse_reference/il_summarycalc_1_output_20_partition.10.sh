...
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P11 > work/kat/il_S1_summarycalc_P11 & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P11 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P11 > /dev/null & pid2=$!
