...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P17 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P17  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P17  ) & pid21=$!
( evepy 17 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P17 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P17 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P17  ) & pid22=$!
