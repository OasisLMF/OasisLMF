...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P22 > work/kat/il_S1_eltcalc_P22 & pid1=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P22 > work/kat/il_S1_summarycalc_P22 & pid2=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P22 > work/kat/il_S1_pltcalc_P22 & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P22 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P22 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P22 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P22 work/il_S1_summaryaalcalc/P22.bin work/il_S1_summaryleccalc/P22.bin > /dev/null & pid4=$!
summarycalc -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P22 < /tmp/%FIFO_DIR%/fifo/il_P22 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P22 > work/kat/gul_S1_eltcalc_P22 & pid5=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P22 > work/kat/gul_S1_summarycalc_P22 & pid6=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P22 > work/kat/gul_S1_pltcalc_P22 & pid7=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P22 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P22 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P22 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P22 work/gul_S1_summaryaalcalc/P22.bin work/gul_S1_summaryleccalc/P22.bin > /dev/null & pid8=$!
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P22 < /tmp/%FIFO_DIR%/fifo/gul_P22 &

eve 22 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P22 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P22 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P22  &
