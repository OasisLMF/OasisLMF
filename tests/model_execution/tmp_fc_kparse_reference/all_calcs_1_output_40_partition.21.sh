...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P22 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P22  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P22  ) & pid21=$!
( evepy 22 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P22 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P22 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P22  ) & pid22=$!
