...
find /tmp/%FIFO_DIR%/fifo/ \( -name '*P21[^0-9]*' -o -name '*P21' \) -exec rm -R -f {} +
...
pltcalc -H < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P21 > work/full_correlation/kat/il_S1_pltcalc_P21 & pid13=$!
...
pltcalc -H < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P21 > work/full_correlation/kat/gul_S1_pltcalc_P21 & pid18=$!
...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P21 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P21  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P21  ) & pid21=$!
( evepy 21 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P21 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P21 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P21  ) & pid22=$!
