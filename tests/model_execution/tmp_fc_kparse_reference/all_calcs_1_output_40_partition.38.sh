...
( tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P39 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P39  | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/full_correlation/il_P39  ) & pid21=$!
( evepy 39 40 | getmodel | gulcalc -S100 -L100 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_fc_P39 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P39 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P39  ) & pid22=$!
