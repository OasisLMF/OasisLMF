...
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_pltcalc_P28 > work/kat/il_S1_pltcalc_P28 & pid3=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P28.idx work/il_S1_summaryleccalc/P28.idx > /dev/null & pid5=$!
...
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_pltcalc_P28 > work/kat/gul_S1_pltcalc_P28 & pid8=$!
...
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P28.idx work/gul_S1_summaryleccalc/P28.idx > /dev/null & pid10=$!
summarycalc -m -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P28 < /tmp/%FIFO_DIR%/fifo/gul_P28 &

# --- Do insured loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P28 > work/full_correlation/kat/il_S1_eltcalc_P28 & pid11=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P28 > work/full_correlation/kat/il_S1_summarycalc_P28 & pid12=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P28 > work/full_correlation/kat/il_S1_pltcalc_P28 & pid13=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P28 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P28 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P28 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P28 work/full_correlation/il_S1_summaryaalcalc/P28.bin work/full_correlation/il_S1_summaryleccalc/P28.bin > /dev/null & pid14=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P28.idx work/full_correlation/il_S1_summaryleccalc/P28.idx > /dev/null & pid15=$!
summarycalc -m -f  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P28 < /tmp/%FIFO_DIR%/fifo/full_correlation/il_P28 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P28 > work/full_correlation/kat/gul_S1_eltcalc_P28 & pid16=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P28 > work/full_correlation/kat/gul_S1_summarycalc_P28 & pid17=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P28 > work/full_correlation/kat/gul_S1_pltcalc_P28 & pid18=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P28 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P28 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P28 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P28 work/full_correlation/gul_S1_summaryaalcalc/P28.bin work/full_correlation/gul_S1_summaryleccalc/P28.bin > /dev/null & pid19=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P28.idx work/full_correlation/gul_S1_summaryleccalc/P28.idx > /dev/null & pid20=$!
