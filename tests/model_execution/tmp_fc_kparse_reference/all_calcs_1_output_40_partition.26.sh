...
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_pltcalc_P27 > work/kat/il_S1_pltcalc_P27 & pid3=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P27.idx work/il_S1_summaryleccalc/P27.idx > /dev/null & pid5=$!
...
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_pltcalc_P27 > work/kat/gul_S1_pltcalc_P27 & pid8=$!
...
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P27.idx work/gul_S1_summaryleccalc/P27.idx > /dev/null & pid10=$!
summarycalc -m -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P27 < /tmp/%FIFO_DIR%/fifo/gul_P27 &

# --- Do insured loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P27 > work/full_correlation/kat/il_S1_eltcalc_P27 & pid11=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P27 > work/full_correlation/kat/il_S1_summarycalc_P27 & pid12=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P27 > work/full_correlation/kat/il_S1_pltcalc_P27 & pid13=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P27 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_eltcalc_P27 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarycalc_P27 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_pltcalc_P27 work/full_correlation/il_S1_summaryaalcalc/P27.bin work/full_correlation/il_S1_summaryleccalc/P27.bin > /dev/null & pid14=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P27.idx work/full_correlation/il_S1_summaryleccalc/P27.idx > /dev/null & pid15=$!
summarycalc -m -f  -1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P27 < /tmp/%FIFO_DIR%/fifo/full_correlation/il_P27 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P27 > work/full_correlation/kat/gul_S1_eltcalc_P27 & pid16=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P27 > work/full_correlation/kat/gul_S1_summarycalc_P27 & pid17=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P27 > work/full_correlation/kat/gul_S1_pltcalc_P27 & pid18=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P27 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_eltcalc_P27 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarycalc_P27 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_pltcalc_P27 work/full_correlation/gul_S1_summaryaalcalc/P27.bin work/full_correlation/gul_S1_summaryleccalc/P27.bin > /dev/null & pid19=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summary_P27.idx work/full_correlation/gul_S1_summaryleccalc/P27.idx > /dev/null & pid20=$!
...
kat -s work/full_correlation/kat/il_S1_eltcalc_P27 > output/full_correlation/il_S1_eltcalc.csv & kpid4=$!
...
kat -s work/kat/gul_S1_eltcalc_P27 > output/gul_S1_eltcalc.csv & kpid7=$!
...
kat -s work/full_correlation/kat/gul_S1_eltcalc_P27 > output/full_correlation/gul_S1_eltcalc.csv & kpid10=$!
