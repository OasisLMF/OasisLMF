...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P30 > work/kat/il_S1_eltcalc_P30 & pid1=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P30 > work/kat/il_S1_summarycalc_P30 & pid2=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P30 > work/kat/il_S1_pltcalc_P30 & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P30 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P30 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P30 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P30 work/il_S1_summaryaalcalc/P30.bin work/il_S1_summaryleccalc/P30.bin > /dev/null & pid4=$!
summarycalc -f  -1 /tmp/%FIFO_DIR%/fifo/il_S1_summary_P30 < /tmp/%FIFO_DIR%/fifo/il_P30 &

# --- Do ground up loss computes ---
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P30 > work/kat/gul_S1_eltcalc_P30 & pid5=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P30 > work/kat/gul_S1_summarycalc_P30 & pid6=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P30 > work/kat/gul_S1_pltcalc_P30 & pid7=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P30 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P30 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P30 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P30 work/gul_S1_summaryaalcalc/P30.bin work/gul_S1_summaryleccalc/P30.bin > /dev/null & pid8=$!
summarycalc -i  -1 /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P30 < /tmp/%FIFO_DIR%/fifo/gul_P30 &

eve 30 40 | getmodel | gulcalc -S100 -L100 -r -j gul_P30 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P30 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P30  &
