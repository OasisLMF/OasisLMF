...
tee < fifo/gul_S1_summary_P1 work/gul_S1_summary_palt/P1.bin work/gul_S1_summaryleccalc/P1.bin > /dev/null & pid9=$!
tee < fifo/gul_S1_summary_P1.idx work/gul_S1_summary_palt/P1.idx work/gul_S1_summaryleccalc/P1.idx > /dev/null & pid10=$!
tee < fifo/gul_S2_summary_P1 work/gul_S2_summary_palt/P1.bin work/gul_S2_summaryleccalc/P1.bin > /dev/null & pid11=$!
tee < fifo/gul_S2_summary_P1.idx work/gul_S2_summary_palt/P1.idx work/gul_S2_summaryleccalc/P1.idx > /dev/null & pid12=$!
tee < fifo/gul_S1_summary_P2 work/gul_S1_summary_palt/P2.bin work/gul_S1_summaryleccalc/P2.bin > /dev/null & pid13=$!
tee < fifo/gul_S1_summary_P2.idx work/gul_S1_summary_palt/P2.idx work/gul_S1_summaryleccalc/P2.idx > /dev/null & pid14=$!
tee < fifo/gul_S2_summary_P2 work/gul_S2_summary_palt/P2.bin work/gul_S2_summaryleccalc/P2.bin > /dev/null & pid15=$!
tee < fifo/gul_S2_summary_P2.idx work/gul_S2_summary_palt/P2.idx work/gul_S2_summaryleccalc/P2.idx > /dev/null & pid16=$!
...
( evepy 1 2 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a0  | tee fifo/gul_P1 > fifo/gul_lb_P1  ) & 
( evepy 2 2 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a0  | tee fifo/gul_P2 > fifo/gul_lb_P2  ) & 
...
wait -p pid_exitcode $pid1 $pid2 $pid3 $pid4 $pid5 $pid6 $pid7 $pid8 $pid9 $pid10 $pid11 $pid12 $pid13 $pid14 $pid15 $pid16 $pid17 $pid18
