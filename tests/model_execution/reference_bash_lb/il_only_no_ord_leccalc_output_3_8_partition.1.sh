...
pltpy -E bin  -H -s work/kat/il_S2_plt_sample_P2 -q work/kat/il_S2_plt_quantile_P2 -m work/kat/il_S2_plt_moment_P2 < fifo/il_S2_plt_ord_P2 & pid3=$!
tee < fifo/il_S1_summary_P2 fifo/il_S1_elt_ord_P2 fifo/il_S1_selt_ord_P2 > /dev/null & pid4=$!
tee < fifo/il_S2_summary_P2 fifo/il_S2_plt_ord_P2 > /dev/null & pid5=$!
tee < fifo/il_S3_summary_P2 work/il_S3_summary_palt/P2.bin work/il_S3_summary_altmeanonly/P2.bin > /dev/null & pid6=$!
...
( evepy 2 8 | gulmc --socket-server='False' --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a0  | fmpy -a2 > fifo/il_P2  ) & pid8=$!
