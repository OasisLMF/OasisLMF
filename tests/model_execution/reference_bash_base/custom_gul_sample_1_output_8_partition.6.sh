...
eltpy -E bin  -H -s work/kat/gul_S1_elt_sample_P7 < fifo/gul_S1_selt_ord_P7 & pid1=$!
...
( evepy 7 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a0  > fifo/gul_P7  ) &  pid3=$!
