...
tee < fifo/il_S2_summary_P3 work/il_S2_summary_palt/P3.bin work/il_S2_summaryleccalc/P3.bin > /dev/null & pid3=$!
tee < fifo/il_S2_summary_P3.idx work/il_S2_summary_palt/P3.idx work/il_S2_summaryleccalc/P3.idx > /dev/null & pid4=$!
summarypy -m -t il  -1 fifo/il_S1_summary_P3 -2 fifo/il_S2_summary_P3 < fifo/il_P3 &

# --- Do ground up loss computes ---
tee < fifo/gul_S1_summary_P3 work/gul_S1_summary_palt/P3.bin work/gul_S1_summaryleccalc/P3.bin > /dev/null & pid5=$!
tee < fifo/gul_S1_summary_P3.idx work/gul_S1_summary_palt/P3.idx work/gul_S1_summaryleccalc/P3.idx > /dev/null & pid6=$!
tee < fifo/gul_S2_summary_P3 work/gul_S2_summary_palt/P3.bin work/gul_S2_summaryleccalc/P3.bin > /dev/null & pid7=$!
...
( evepy 3 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a0  | tee fifo/gul_P3 | fmpy -a2 > fifo/il_P3  ) & pid9=$!
