...
tee < fifo/il_S2_summary_P7 work/il_S2_summaryleccalc/P7.bin > /dev/null & pid3=$!
tee < fifo/il_S2_summary_P7.idx work/il_S2_summaryleccalc/P7.idx > /dev/null & pid4=$!
summarypy -m -t il  -1 fifo/il_S1_summary_P7 -2 fifo/il_S2_summary_P7 < fifo/il_P7 &

# --- Do ground up loss computes ---
tee < fifo/gul_S1_summary_P7 work/gul_S1_summaryleccalc/P7.bin > /dev/null & pid5=$!
tee < fifo/gul_S1_summary_P7.idx work/gul_S1_summaryleccalc/P7.idx > /dev/null & pid6=$!
tee < fifo/gul_S2_summary_P7 work/gul_S2_summaryleccalc/P7.bin > /dev/null & pid7=$!
tee < fifo/gul_S2_summary_P7.idx work/gul_S2_summaryleccalc/P7.idx > /dev/null & pid8=$!
