...
tee < fifo/gul_S1_summary_P1 work/gul_S1_summary_palt/P1.bin work/gul_S1_summaryleccalc/P1.bin > /dev/null & pid5=$!
tee < fifo/gul_S1_summary_P1.idx work/gul_S1_summary_palt/P1.idx work/gul_S1_summaryleccalc/P1.idx > /dev/null & pid6=$!
tee < fifo/gul_S2_summary_P1 work/gul_S2_summary_palt/P1.bin work/gul_S2_summaryleccalc/P1.bin > /dev/null & pid7=$!
tee < fifo/gul_S2_summary_P1.idx work/gul_S2_summary_palt/P1.idx work/gul_S2_summaryleccalc/P1.idx > /dev/null & pid8=$!
...
( evepy 1 1 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a0  | tee fifo/gul_P1 | fmpy -a2 > fifo/il_P1  ) & pid9=$!
