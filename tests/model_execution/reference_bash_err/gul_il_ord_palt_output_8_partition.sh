...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P1 work/il_S2_summary_palt/P1.bin work/il_S2_summaryleccalc/P1.bin > /dev/null & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P1.idx work/il_S2_summary_palt/P1.idx work/il_S2_summaryleccalc/P1.idx > /dev/null & pid4=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P2 work/il_S2_summary_palt/P2.bin work/il_S2_summaryleccalc/P2.bin > /dev/null & pid7=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P2.idx work/il_S2_summary_palt/P2.idx work/il_S2_summaryleccalc/P2.idx > /dev/null & pid8=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P3 work/il_S2_summary_palt/P3.bin work/il_S2_summaryleccalc/P3.bin > /dev/null & pid11=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P3.idx work/il_S2_summary_palt/P3.idx work/il_S2_summaryleccalc/P3.idx > /dev/null & pid12=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P4 work/il_S2_summary_palt/P4.bin work/il_S2_summaryleccalc/P4.bin > /dev/null & pid15=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P4.idx work/il_S2_summary_palt/P4.idx work/il_S2_summaryleccalc/P4.idx > /dev/null & pid16=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P5 work/il_S2_summary_palt/P5.bin work/il_S2_summaryleccalc/P5.bin > /dev/null & pid19=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P5.idx work/il_S2_summary_palt/P5.idx work/il_S2_summaryleccalc/P5.idx > /dev/null & pid20=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P6 work/il_S2_summary_palt/P6.bin work/il_S2_summaryleccalc/P6.bin > /dev/null & pid23=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P6.idx work/il_S2_summary_palt/P6.idx work/il_S2_summaryleccalc/P6.idx > /dev/null & pid24=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P7 work/il_S2_summary_palt/P7.bin work/il_S2_summaryleccalc/P7.bin > /dev/null & pid27=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P7.idx work/il_S2_summary_palt/P7.idx work/il_S2_summaryleccalc/P7.idx > /dev/null & pid28=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P8 work/il_S2_summary_palt/P8.bin work/il_S2_summaryleccalc/P8.bin > /dev/null & pid31=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P8.idx work/il_S2_summary_palt/P8.idx work/il_S2_summaryleccalc/P8.idx > /dev/null & pid32=$!
...
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P1 work/gul_S1_summary_palt/P1.bin work/gul_S1_summaryleccalc/P1.bin > /dev/null & pid33=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P1.idx work/gul_S1_summary_palt/P1.idx work/gul_S1_summaryleccalc/P1.idx > /dev/null & pid34=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P1 work/gul_S2_summary_palt/P1.bin work/gul_S2_summaryleccalc/P1.bin > /dev/null & pid35=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P1.idx work/gul_S2_summary_palt/P1.idx work/gul_S2_summaryleccalc/P1.idx > /dev/null & pid36=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P2 work/gul_S1_summary_palt/P2.bin work/gul_S1_summaryleccalc/P2.bin > /dev/null & pid37=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P2.idx work/gul_S1_summary_palt/P2.idx work/gul_S1_summaryleccalc/P2.idx > /dev/null & pid38=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P2 work/gul_S2_summary_palt/P2.bin work/gul_S2_summaryleccalc/P2.bin > /dev/null & pid39=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P2.idx work/gul_S2_summary_palt/P2.idx work/gul_S2_summaryleccalc/P2.idx > /dev/null & pid40=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P3 work/gul_S1_summary_palt/P3.bin work/gul_S1_summaryleccalc/P3.bin > /dev/null & pid41=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P3.idx work/gul_S1_summary_palt/P3.idx work/gul_S1_summaryleccalc/P3.idx > /dev/null & pid42=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P3 work/gul_S2_summary_palt/P3.bin work/gul_S2_summaryleccalc/P3.bin > /dev/null & pid43=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P3.idx work/gul_S2_summary_palt/P3.idx work/gul_S2_summaryleccalc/P3.idx > /dev/null & pid44=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P4 work/gul_S1_summary_palt/P4.bin work/gul_S1_summaryleccalc/P4.bin > /dev/null & pid45=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P4.idx work/gul_S1_summary_palt/P4.idx work/gul_S1_summaryleccalc/P4.idx > /dev/null & pid46=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P4 work/gul_S2_summary_palt/P4.bin work/gul_S2_summaryleccalc/P4.bin > /dev/null & pid47=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P4.idx work/gul_S2_summary_palt/P4.idx work/gul_S2_summaryleccalc/P4.idx > /dev/null & pid48=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P5 work/gul_S1_summary_palt/P5.bin work/gul_S1_summaryleccalc/P5.bin > /dev/null & pid49=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P5.idx work/gul_S1_summary_palt/P5.idx work/gul_S1_summaryleccalc/P5.idx > /dev/null & pid50=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P5 work/gul_S2_summary_palt/P5.bin work/gul_S2_summaryleccalc/P5.bin > /dev/null & pid51=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P5.idx work/gul_S2_summary_palt/P5.idx work/gul_S2_summaryleccalc/P5.idx > /dev/null & pid52=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6 work/gul_S1_summary_palt/P6.bin work/gul_S1_summaryleccalc/P6.bin > /dev/null & pid53=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6.idx work/gul_S1_summary_palt/P6.idx work/gul_S1_summaryleccalc/P6.idx > /dev/null & pid54=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P6 work/gul_S2_summary_palt/P6.bin work/gul_S2_summaryleccalc/P6.bin > /dev/null & pid55=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P6.idx work/gul_S2_summary_palt/P6.idx work/gul_S2_summaryleccalc/P6.idx > /dev/null & pid56=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P7 work/gul_S1_summary_palt/P7.bin work/gul_S1_summaryleccalc/P7.bin > /dev/null & pid57=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P7.idx work/gul_S1_summary_palt/P7.idx work/gul_S1_summaryleccalc/P7.idx > /dev/null & pid58=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P7 work/gul_S2_summary_palt/P7.bin work/gul_S2_summaryleccalc/P7.bin > /dev/null & pid59=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P7.idx work/gul_S2_summary_palt/P7.idx work/gul_S2_summaryleccalc/P7.idx > /dev/null & pid60=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P8 work/gul_S1_summary_palt/P8.bin work/gul_S1_summaryleccalc/P8.bin > /dev/null & pid61=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P8.idx work/gul_S1_summary_palt/P8.idx work/gul_S1_summaryleccalc/P8.idx > /dev/null & pid62=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P8 work/gul_S2_summary_palt/P8.bin work/gul_S2_summaryleccalc/P8.bin > /dev/null & pid63=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P8.idx work/gul_S2_summary_palt/P8.idx work/gul_S2_summaryleccalc/P8.idx > /dev/null & pid64=$!
...
( ( evepy 1 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P1 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P1  ) 2>> $LOG_DIR/stderror.err ) & pid65=$!
( ( evepy 2 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P2 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P2  ) 2>> $LOG_DIR/stderror.err ) & pid66=$!
( ( evepy 3 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P3 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P3  ) 2>> $LOG_DIR/stderror.err ) & pid67=$!
( ( evepy 4 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P4 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P4  ) 2>> $LOG_DIR/stderror.err ) & pid68=$!
( ( evepy 5 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P5 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P5  ) 2>> $LOG_DIR/stderror.err ) & pid69=$!
( ( evepy 6 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P6 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P6  ) 2>> $LOG_DIR/stderror.err ) & pid70=$!
( ( evepy 7 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P7 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P7  ) 2>> $LOG_DIR/stderror.err ) & pid71=$!
( ( evepy 8 8 | gulmc --random-generator=2  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S0 -L0 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P8 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P8  ) 2>> $LOG_DIR/stderror.err ) & pid72=$!
...
( aalpy -Kil_S2_summary_palt -a output/il_S2_palt.csv ) 2>> $LOG_DIR/stderror.err & lpid2=$!
( lecpy -r -Kil_S2_summaryleccalc -F -S -s -M -m -W -w -O output/il_S2_ept.csv -o output/il_S2_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid3=$!
( aalpy -Kgul_S1_summary_palt -a output/gul_S1_palt.csv ) 2>> $LOG_DIR/stderror.err & lpid4=$!
( lecpy -r -Kgul_S1_summaryleccalc -F -S -s -M -m -W -w -O output/gul_S1_ept.csv -o output/gul_S1_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid5=$!
( aalpy -Kgul_S2_summary_palt -a output/gul_S2_palt.csv ) 2>> $LOG_DIR/stderror.err & lpid6=$!
( lecpy -r -Kgul_S2_summaryleccalc -F -S -s -M -m -W -w -O output/gul_S2_ept.csv -o output/gul_S2_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid7=$!
