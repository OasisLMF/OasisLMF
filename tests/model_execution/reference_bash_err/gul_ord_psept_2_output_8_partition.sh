...
( lecpy  -Kgul_S1_summaryleccalc -W -w -o output/gul_S1_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid1=$!
( lecpy -r -Kgul_S2_summaryleccalc -W -w -o output/gul_S2_psept.csv ) 2>> $LOG_DIR/stderror.err & lpid2=$!
