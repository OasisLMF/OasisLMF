...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P2 work/il_S2_summaryleccalc/P2.bin > /dev/null & pid3=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P2.idx work/il_S2_summaryleccalc/P2.idx > /dev/null & pid4=$!
