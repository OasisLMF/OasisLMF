...
( eltpy -E bin  -H -s work/kat/gul_S1_elt_sample_P6 < /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P6 ) 2>> $LOG_DIR/stderror.err & pid1=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6 /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P6 > /dev/null & pid2=$!
...
( ( evepy 6 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  > /tmp/%FIFO_DIR%/fifo/gul_P6  ) 2>> $LOG_DIR/stderror.err ) &  pid3=$!
