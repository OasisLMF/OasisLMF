...
check_fifos \
    ...
    /tmp/%FIFO_DIR%/fifo/gul_S1_plt_ord_P2 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_elt_ord_P2 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P2 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P3 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P3.idx \
    /tmp/%FIFO_DIR%/fifo/gul_S1_plt_ord_P3 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_elt_ord_P3 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P3 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P4 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P4.idx \
    /tmp/%FIFO_DIR%/fifo/gul_S1_plt_ord_P4 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_elt_ord_P4 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P4 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P5 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P5.idx \
    /tmp/%FIFO_DIR%/fifo/gul_S1_plt_ord_P5 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_elt_ord_P5 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P5 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6.idx \
    /tmp/%FIFO_DIR%/fifo/gul_S1_plt_ord_P6 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_elt_ord_P6 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P6 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P7 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P7.idx \
    /tmp/%FIFO_DIR%/fifo/gul_S1_plt_ord_P7 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_elt_ord_P7 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P7 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P8 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P8.idx \
    /tmp/%FIFO_DIR%/fifo/gul_S1_plt_ord_P8 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_elt_ord_P8 \
    /tmp/%FIFO_DIR%/fifo/gul_S1_selt_ord_P8 \
    ...
    /tmp/%FIFO_DIR%/fifo/il_S1_plt_ord_P2 \
    /tmp/%FIFO_DIR%/fifo/il_S1_elt_ord_P2 \
    /tmp/%FIFO_DIR%/fifo/il_S1_selt_ord_P2 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P3 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P3.idx \
    /tmp/%FIFO_DIR%/fifo/il_S1_plt_ord_P3 \
    /tmp/%FIFO_DIR%/fifo/il_S1_elt_ord_P3 \
    /tmp/%FIFO_DIR%/fifo/il_S1_selt_ord_P3 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P4 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P4.idx \
    /tmp/%FIFO_DIR%/fifo/il_S1_plt_ord_P4 \
    /tmp/%FIFO_DIR%/fifo/il_S1_elt_ord_P4 \
    /tmp/%FIFO_DIR%/fifo/il_S1_selt_ord_P4 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P5 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P5.idx \
    /tmp/%FIFO_DIR%/fifo/il_S1_plt_ord_P5 \
    /tmp/%FIFO_DIR%/fifo/il_S1_elt_ord_P5 \
    /tmp/%FIFO_DIR%/fifo/il_S1_selt_ord_P5 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P6 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P6.idx \
    /tmp/%FIFO_DIR%/fifo/il_S1_plt_ord_P6 \
    /tmp/%FIFO_DIR%/fifo/il_S1_elt_ord_P6 \
    /tmp/%FIFO_DIR%/fifo/il_S1_selt_ord_P6 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P7 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P7.idx \
    /tmp/%FIFO_DIR%/fifo/il_S1_plt_ord_P7 \
    /tmp/%FIFO_DIR%/fifo/il_S1_elt_ord_P7 \
    /tmp/%FIFO_DIR%/fifo/il_S1_selt_ord_P7 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P8 \
    /tmp/%FIFO_DIR%/fifo/il_S1_summary_P8.idx \
    /tmp/%FIFO_DIR%/fifo/il_S1_plt_ord_P8 \
    /tmp/%FIFO_DIR%/fifo/il_S1_elt_ord_P8 \
    /tmp/%FIFO_DIR%/fifo/il_S1_selt_ord_P8

( ( evepy 1 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P1 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P1  ) 2>> $LOG_DIR/stderror.err ) & pid81=$!
( ( evepy 2 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P2 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P2  ) 2>> $LOG_DIR/stderror.err ) & pid82=$!
( ( evepy 3 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P3 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P3  ) 2>> $LOG_DIR/stderror.err ) & pid83=$!
( ( evepy 4 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P4 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P4  ) 2>> $LOG_DIR/stderror.err ) & pid84=$!
( ( evepy 5 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P5 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P5  ) 2>> $LOG_DIR/stderror.err ) & pid85=$!
( ( evepy 6 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P6 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P6  ) 2>> $LOG_DIR/stderror.err ) & pid86=$!
( ( evepy 7 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P7 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P7  ) 2>> $LOG_DIR/stderror.err ) & pid87=$!
( ( evepy 8 8 | gulmc --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee /tmp/%FIFO_DIR%/fifo/gul_P8 | fmpy -a2 > /tmp/%FIFO_DIR%/fifo/il_P8  ) 2>> $LOG_DIR/stderror.err ) & pid88=$!
...
katpy -Q -f bin -i work/kat/il_S1_plt_quantile_P1 work/kat/il_S1_plt_quantile_P2 work/kat/il_S1_plt_quantile_P3 work/kat/il_S1_plt_quantile_P4 work/kat/il_S1_plt_quantile_P5 work/kat/il_S1_plt_quantile_P6 work/kat/il_S1_plt_quantile_P7 work/kat/il_S1_plt_quantile_P8 -o output/il_S1_qplt.parquet & kpid2=$!
katpy -M -f bin -i work/kat/il_S1_plt_moment_P1 work/kat/il_S1_plt_moment_P2 work/kat/il_S1_plt_moment_P3 work/kat/il_S1_plt_moment_P4 work/kat/il_S1_plt_moment_P5 work/kat/il_S1_plt_moment_P6 work/kat/il_S1_plt_moment_P7 work/kat/il_S1_plt_moment_P8 -o output/il_S1_mplt.parquet & kpid3=$!
katpy -q -f bin -i work/kat/il_S1_elt_quantile_P1 work/kat/il_S1_elt_quantile_P2 work/kat/il_S1_elt_quantile_P3 work/kat/il_S1_elt_quantile_P4 work/kat/il_S1_elt_quantile_P5 work/kat/il_S1_elt_quantile_P6 work/kat/il_S1_elt_quantile_P7 work/kat/il_S1_elt_quantile_P8 -o output/il_S1_qelt.parquet & kpid4=$!
katpy -m -f bin -i work/kat/il_S1_elt_moment_P1 work/kat/il_S1_elt_moment_P2 work/kat/il_S1_elt_moment_P3 work/kat/il_S1_elt_moment_P4 work/kat/il_S1_elt_moment_P5 work/kat/il_S1_elt_moment_P6 work/kat/il_S1_elt_moment_P7 work/kat/il_S1_elt_moment_P8 -o output/il_S1_melt.parquet & kpid5=$!
katpy -s -f bin -i work/kat/il_S1_elt_sample_P1 work/kat/il_S1_elt_sample_P2 work/kat/il_S1_elt_sample_P3 work/kat/il_S1_elt_sample_P4 work/kat/il_S1_elt_sample_P5 work/kat/il_S1_elt_sample_P6 work/kat/il_S1_elt_sample_P7 work/kat/il_S1_elt_sample_P8 -o output/il_S1_selt.parquet & kpid6=$!

# --- Do ground up loss kats ---

katpy -S -f bin -i work/kat/gul_S1_plt_sample_P1 work/kat/gul_S1_plt_sample_P2 work/kat/gul_S1_plt_sample_P3 work/kat/gul_S1_plt_sample_P4 work/kat/gul_S1_plt_sample_P5 work/kat/gul_S1_plt_sample_P6 work/kat/gul_S1_plt_sample_P7 work/kat/gul_S1_plt_sample_P8 -o output/gul_S1_splt.parquet & kpid7=$!
katpy -Q -f bin -i work/kat/gul_S1_plt_quantile_P1 work/kat/gul_S1_plt_quantile_P2 work/kat/gul_S1_plt_quantile_P3 work/kat/gul_S1_plt_quantile_P4 work/kat/gul_S1_plt_quantile_P5 work/kat/gul_S1_plt_quantile_P6 work/kat/gul_S1_plt_quantile_P7 work/kat/gul_S1_plt_quantile_P8 -o output/gul_S1_qplt.parquet & kpid8=$!
katpy -M -f bin -i work/kat/gul_S1_plt_moment_P1 work/kat/gul_S1_plt_moment_P2 work/kat/gul_S1_plt_moment_P3 work/kat/gul_S1_plt_moment_P4 work/kat/gul_S1_plt_moment_P5 work/kat/gul_S1_plt_moment_P6 work/kat/gul_S1_plt_moment_P7 work/kat/gul_S1_plt_moment_P8 -o output/gul_S1_mplt.parquet & kpid9=$!
