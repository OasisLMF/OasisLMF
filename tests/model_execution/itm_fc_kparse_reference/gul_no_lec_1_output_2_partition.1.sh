...
tee < fifo/gul_S1_summary_P2 fifo/gul_S1_summaryeltcalc_P2 fifo/gul_S1_summarypltcalc_P2 fifo/gul_S1_summarysummarycalc_P2 work/gul_S1_summaryaalcalc/P2.bin > /dev/null & pid4=$!
...
tee < gul_S1_summary_P2 gul_S1_summaryeltcalc_P2 gul_S1_summarypltcalc_P2 gul_S1_summarysummarycalc_P2 work/full_correlation/gul_S1_summaryaalcalc/P2.bin > /dev/null & pid4=$!
