...
tee < fifo/full_correlation/il_S2_summary_P1 fifo/full_correlation/il_S2_summaryeltcalc_P1 fifo/full_correlation/il_S2_summarypltcalc_P1 fifo/full_correlation/il_S2_summarysummarycalc_P1 work/full_correlation/il_S2_summaryaalcalc/P1.bin > /dev/null & pid8=$!
...
eltcalc < fifo/full_correlation/gul_S2_summaryeltcalc_P1 > work/full_correlation/kat/gul_S2_eltcalc_P1 & pid12=$!
summarycalctocsv < fifo/full_correlation/gul_S2_summarysummarycalc_P1 > work/full_correlation/kat/gul_S2_summarycalc_P1 & pid13=$!
pltcalc < fifo/full_correlation/gul_S2_summarypltcalc_P1 > work/full_correlation/kat/gul_S2_pltcalc_P1 & pid14=$!

tee < fifo/full_correlation/gul_S1_summary_P1 fifo/full_correlation/gul_S1_summaryeltcalc_P1 fifo/full_correlation/gul_S1_summarypltcalc_P1 fifo/full_correlation/gul_S1_summarysummarycalc_P1 work/full_correlation/gul_S1_summaryaalcalc/P1.bin > /dev/null & pid15=$!
tee < fifo/full_correlation/gul_S2_summary_P1 fifo/full_correlation/gul_S2_summaryeltcalc_P1 fifo/full_correlation/gul_S2_summarypltcalc_P1 fifo/full_correlation/gul_S2_summarysummarycalc_P1 work/full_correlation/gul_S2_summaryaalcalc/P1.bin > /dev/null & pid16=$!
