...
summarycalctocsv -s < fifo/gul_S1_summarysummarycalc_P4 > work/kat/gul_S1_summarycalc_P4 & pid1=$!
tee < fifo/gul_S1_summary_P4 fifo/gul_S1_summarysummarycalc_P4 > /dev/null & pid2=$!
