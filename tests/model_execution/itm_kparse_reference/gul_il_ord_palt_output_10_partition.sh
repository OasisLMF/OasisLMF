...
( evepy 1 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P1 | fmcalc -a2 > fifo/il_P1  ) & pid201=$!
( evepy 2 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P2 | fmcalc -a2 > fifo/il_P2  ) & pid202=$!
( evepy 3 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P3 | fmcalc -a2 > fifo/il_P3  ) & pid203=$!
( evepy 4 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P4 | fmcalc -a2 > fifo/il_P4  ) & pid204=$!
( evepy 5 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P5 | fmcalc -a2 > fifo/il_P5  ) & pid205=$!
( evepy 6 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P6 | fmcalc -a2 > fifo/il_P6  ) & pid206=$!
( evepy 7 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P7 | fmcalc -a2 > fifo/il_P7  ) & pid207=$!
( evepy 8 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P8 | fmcalc -a2 > fifo/il_P8  ) & pid208=$!
( evepy 9 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P9 | fmcalc -a2 > fifo/il_P9  ) & pid209=$!
( evepy 10 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - | tee fifo/gul_P10 | fmcalc -a2 > fifo/il_P10  ) & pid210=$!
