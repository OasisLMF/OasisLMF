...
( ( eve 1 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P1  ) 2>> $LOG_DIR/stderror.err ) &  pid101=$!
( ( eve 2 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P2  ) 2>> $LOG_DIR/stderror.err ) &  pid102=$!
( ( eve 3 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P3  ) 2>> $LOG_DIR/stderror.err ) &  pid103=$!
( ( eve 4 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P4  ) 2>> $LOG_DIR/stderror.err ) &  pid104=$!
( ( eve 5 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P5  ) 2>> $LOG_DIR/stderror.err ) &  pid105=$!
( ( eve 6 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P6  ) 2>> $LOG_DIR/stderror.err ) &  pid106=$!
( ( eve 7 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P7  ) 2>> $LOG_DIR/stderror.err ) &  pid107=$!
( ( eve 8 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P8  ) 2>> $LOG_DIR/stderror.err ) &  pid108=$!
( ( eve 9 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P9  ) 2>> $LOG_DIR/stderror.err ) &  pid109=$!
( ( eve 10 10 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P10  ) 2>> $LOG_DIR/stderror.err ) &  pid110=$!
