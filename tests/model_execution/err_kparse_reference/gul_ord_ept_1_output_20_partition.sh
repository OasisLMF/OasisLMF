...
( ( eve 1 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P1  ) 2>> $LOG_DIR/stderror.err ) &  pid41=$!
( ( eve 2 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P2  ) 2>> $LOG_DIR/stderror.err ) &  pid42=$!
( ( eve 3 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P3  ) 2>> $LOG_DIR/stderror.err ) &  pid43=$!
( ( eve 4 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P4  ) 2>> $LOG_DIR/stderror.err ) &  pid44=$!
( ( eve 5 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P5  ) 2>> $LOG_DIR/stderror.err ) &  pid45=$!
( ( eve 6 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P6  ) 2>> $LOG_DIR/stderror.err ) &  pid46=$!
( ( eve 7 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P7  ) 2>> $LOG_DIR/stderror.err ) &  pid47=$!
( ( eve 8 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P8  ) 2>> $LOG_DIR/stderror.err ) &  pid48=$!
( ( eve 9 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P9  ) 2>> $LOG_DIR/stderror.err ) &  pid49=$!
( ( eve 10 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P10  ) 2>> $LOG_DIR/stderror.err ) &  pid50=$!
( ( eve 11 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P11  ) 2>> $LOG_DIR/stderror.err ) &  pid51=$!
( ( eve 12 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P12  ) 2>> $LOG_DIR/stderror.err ) &  pid52=$!
( ( eve 13 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P13  ) 2>> $LOG_DIR/stderror.err ) &  pid53=$!
( ( eve 14 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P14  ) 2>> $LOG_DIR/stderror.err ) &  pid54=$!
( ( eve 15 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P15  ) 2>> $LOG_DIR/stderror.err ) &  pid55=$!
( ( eve 16 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P16  ) 2>> $LOG_DIR/stderror.err ) &  pid56=$!
( ( eve 17 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P17  ) 2>> $LOG_DIR/stderror.err ) &  pid57=$!
( ( eve 18 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P18  ) 2>> $LOG_DIR/stderror.err ) &  pid58=$!
( ( eve 19 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P19  ) 2>> $LOG_DIR/stderror.err ) &  pid59=$!
( ( eve 20 20 | getmodel | gulcalc -S0 -L0 -r -a1 -i - > fifo/gul_P20  ) 2>> $LOG_DIR/stderror.err ) &  pid60=$!
