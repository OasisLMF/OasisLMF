...
tee < fifo/il_S1_summary_P25 > /dev/null & pid1=$!
( summarypy -m -t il  -1 fifo/il_S1_summary_P25 < fifo/il_P25 ) 2>> $LOG_DIR/stderror.err  &

# --- Do ground up loss computes ---
tee < fifo/gul_S1_summary_P25 > /dev/null & pid2=$!
( summarypy -m -t gul  -1 fifo/gul_S1_summary_P25 < fifo/gul_P25 ) 2>> $LOG_DIR/stderror.err  &

( ( evepy 25 40 | gulmc --socket-server='False' --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee fifo/gul_P25 | fmpy -a2 > fifo/il_P25  ) 2>> $LOG_DIR/stderror.err ) & pid3=$!
