...
( summarypy -m -t il  -1 fifo/il_S1_summary_P9 < fifo/il_P9 ) 2>> $LOG_DIR/stderror.err  &
...
( ( evepy 9 20 | gulmc --socket-server='False' --random-generator=1  --model-df-engine='oasis_data_manager.df_reader.reader.OasisPandasReader' --vuln-cache-size 200 -S100 -L100 -a1  | tee fifo/gul_P9 | fmpy -a2 > fifo/il_P9  ) 2>> $LOG_DIR/stderror.err ) & pid3=$!
