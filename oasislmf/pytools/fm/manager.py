...
def run_synchronous_dense(max_sidx_val, allocation_rule, static_path, streams_in,
                          files_out, low_memory, net_loss, sort_output, **kwargs):
    ...
    with tempfile.TemporaryDirectory() as tempdir:
        losses, loss_indexes, extras, extra_indexes, children, computes = init_variable(
            compute_info, len_array, tempdir, low_memory)
...
def run_synchronous_sparse(max_sidx_val, allocation_rule, static_path, streams_in,
                           files_out, low_memory, net_loss, sort_output, **kwargs):
    compute_info, nodes_array, node_parents_array, node_profiles_array, output_array, fm_profile = load_financial_structure(
        allocation_rule, static_path)
