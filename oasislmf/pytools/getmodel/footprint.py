...
class FootprintBin(Footprint):
    ...
    def __enter__(self):
        ...
        self.num_intensity_bins = int(footprint_header['num_intensity_bins'][0])
        self.has_intensity_uncertainty = int(footprint_header['has_intensity_uncertainty'][0] & intensityMask)
...
class FootprintBinZ(Footprint):
    ...
    def __enter__(self):
        ...
        self.num_intensity_bins = int(footprint_header['num_intensity_bins'][0])
        self.has_intensity_uncertainty = int(footprint_header['has_intensity_uncertainty'][0] & intensityMask)
        self.uncompressed_size = int((footprint_header['has_intensity_uncertainty'][0] & uncompressedMask) >> 1)
