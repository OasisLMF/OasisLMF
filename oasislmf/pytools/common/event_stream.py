...
class EventReader:
    ...
    def register_streams_in(selector_class, streams_in):
        ...
        stream_data = []
        for file_id, stream_in in enumerate(streams_in):
        ...
        try:
            ...
            for data in stream_data:
                if data['cursor'] < data['valid_buff']:
                    ...
                    yield_event = True
                    while yield_event:
                        cursor, event_id, item_id, yield_event = self.read_buffer(byte_mv, cursor, valid_buff, 0, 0, file_id=file_id)
    ...
    def read_event(self, stream_in, main_selector, stream_selector, mv, byte_mv, cursor, valid_buff, file_id):
        """
        ...
        while True:
            if valid_buff < PIPE_CAPACITY:
                ...
                if len_read == 0:
                    ...
                    break
            cursor, event_id, item_id, yield_event = self.read_buffer(byte_mv, cursor, valid_buff, event_id, item_id, file_id=file_id)
