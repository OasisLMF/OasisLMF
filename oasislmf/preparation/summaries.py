...
def get_exposure_summary_all(df, exposure_summary, peril_id):
    ...
    for coverage_type in SUPPORTED_COVERAGE_TYPES:
        ...
        exposure_summary[peril_id]['all']['number_of_risks_by_coverage'][coverage_type] = int(num_df['number_of_risks'])
    ...
    exposure_summary[peril_id]['all']['number_of_risks'] = int(num_df['number_of_risks'])
