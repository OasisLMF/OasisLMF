...
class OasisExposuresManagerInterface(Interface):  # pragma: no cover
    ...
    def load_canonical_exposure_profile(self, oasis_model=None, **kwargs):
        """
    ...
    def generate_gul_items(self, canonical_exposure_profile, canonical_exposure_df, keys_df, **kwargs):
        """
    ...
    def generate_fm_items(self, canonical_exposure_df, gul_items_df, canonical_exposure_profile, canonical_accounts_profile, canonical_accounts_df, fm_agg_profile, **kwargs):
        """
    ...
    def load_gul_items(self, canonical_exposure_profile, canonical_exposure_file_path, keys_file_path, **kwargs):
        """
        Loads GUL input items generated by ``generate_gul_items`` into a static
    ...
    def load_fm_items(self, canonical_exposure_df, gul_items_df, canonical_exposure_profile, canonical_accounts_profile, canonical_accounts_file_path, fm_agg_profile, **kwargs):
        """
        Loads FM input items generated by ``generate_fm_items`` into a static
        structure such as a pandas dataframe.
...
class OasisExposuresManager(implements(OasisExposuresManagerInterface)):
    ...
    def load_canonical_exposure_profile(self, oasis_model=None, **kwargs):
        ...
        profile_json_path = kwargs.get('canonical_exposure_profile_json_path')
    ...
    def get_keys(self, oasis_model=None, **kwargs):
        ...
        keys_file_path, _, keys_errors_file_path, _ = OasisLookupFactory().save_results(
            ...
            model_exposures_fp=model_exposure_file_path
        )
    ...
    def _process_default_kwargs(self, oasis_model=None, **kwargs):
        if oasis_model:
            ...
            kwargs.setdefault('canonical_exposure_profile_json_path', omr.get('canonical_exposure_profile_json_path'))
    ...
    def load_gul_items(self, canonical_exposure_profile, canonical_exposure_file_path, keys_file_path):
        """
        Loads GUL input items generated by ``generate_gul_items`` into a static
        structure such as a pandas dataframe.
    ...
    def write_gul_files(self, oasis_model=None, **kwargs):
        ...
        gul_items_df, canexp_df = self.load_gul_items(canonical_exposure_profile, canonical_exposure_file_path, keys_file_path)
    ...
    def write_fm_files(self, oasis_model=None, **kwargs):
        ...
        fm_items_df, canacc_df = self.load_fm_items(canexp_df, gul_items_df, canonical_exposure_profile, canonical_accounts_profile, canonical_accounts_file_path, fm_agg_profile)
    ...
    def start_oasis_files_pipeline(
        ...
        **kwargs
        ...
        canonical_exposure_profile = kwargs.get('canonical_exposure_profile') or self.load_canonical_exposure_profile(oasis_model=oasis_model, **kwargs)
    ...
    def create_model(self, model_supplier_id, model_id, model_version, resources=None):
        ...
        if omr.get('canonical_exposure_profile') is None:
            self.load_canonical_exposure_profile(oasis_model=model)
