...
class OasisExposuresManager(implements(OasisExposuresManagerInterface)):
    ...
    def transform_canonical_to_model(self, oasis_model=None, **kwargs):
        ...
        validation_file_path = os.path.abspath(kwargs.get('canonical_exposures_validation_file_path'))
    ...
    def generate_fm_items(
        ...
        try:
            ...
            get_canacc_item = lambda i: canacc_df[(canacc_df['accntnum'] == cangul_df.iloc[coverage_level_preset_data[i][2]]['accntnum']) & (canacc_df['policynum'].str.lower() == 'layer1')].iloc[0]
