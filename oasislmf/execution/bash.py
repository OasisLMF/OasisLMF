...
def get_getmodel_itm_cmd(
    ...
    """
    cmd = f'eve {eve_shuffle_flag}{process_id} {max_process_id} | {get_modelcmd(modelpy, modelpy_server, peril_filter)} | {get_gulcmd(gulpy)} -S{number_of_samples} -L{gul_threshold}'
